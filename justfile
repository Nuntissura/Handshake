...
wp-review-request wp-id actor-role actor-session target-role target-session summary correlation-id='' spec-anchor='' packet-row-ref='':
	@node .GOV/roles_shared/scripts/wp/wp-review-exchange.mjs REVIEW_REQUEST {{wp-id}} {{actor-role}} {{actor-session}} {{target-role}} "{{target-session}}" "{{summary}}" "{{correlation-id}}" "{{spec-anchor}}" "{{packet-row-ref}}"
...
wp-review-response wp-id actor-role actor-session target-role target-session summary correlation-id spec-anchor='' packet-row-ref='' ack-for='':
	@node .GOV/roles_shared/scripts/wp/wp-review-exchange.mjs REVIEW_RESPONSE {{wp-id}} {{actor-role}} {{actor-session}} {{target-role}} "{{target-session}}" "{{summary}}" "{{correlation-id}}" "{{spec-anchor}}" "{{packet-row-ref}}" "{{ack-for}}"

wp-spec-gap wp-id actor-role actor-session target-role target-session summary correlation-id='' spec-anchor='' packet-row-ref='':
	@node .GOV/roles_shared/scripts/wp/wp-review-exchange.mjs SPEC_GAP {{wp-id}} {{actor-role}} {{actor-session}} {{target-role}} "{{target-session}}" "{{summary}}" "{{correlation-id}}" "{{spec-anchor}}" "{{packet-row-ref}}"
...
wp-spec-confirmation wp-id actor-role actor-session target-role target-session summary correlation-id spec-anchor='' packet-row-ref='' ack-for='':
	@node .GOV/roles_shared/scripts/wp/wp-review-exchange.mjs SPEC_CONFIRMATION {{wp-id}} {{actor-role}} {{actor-session}} {{target-role}} "{{target-session}}" "{{summary}}" "{{correlation-id}}" "{{spec-anchor}}" "{{packet-row-ref}}" "{{ack-for}}"
