...
pub const CORPUS_GOVERNED_INVOCATION_FAMILY: &str = "atelier.command_corpus.governed_invocation";
...
mod builtin_table {
    ...
    pub(super) const ROWS: &[BuiltinCommandSpec] = &[
        ...
        // -- model runtime --
        row(
            "kernel_model_runtime_capabilities",
            "model_runtime",
            BOTH,
            PURE,
            false,
        ...
        row(
            "kernel_model_runtime_list_loaded",
            "model_runtime",
            BOTH,
            PURE,
            false,
        ...
        row(
            "kernel_swarm_get_spawn_template",
            "swarm_runtime",
            BOTH,
            PURE,
            false,
        ...
        row(
            "kernel_swarm_resource_snapshot",
            "swarm_runtime",
            BOTH,
            PURE,
            false,
        ...
        row(
            "kernel_swarm_schedule_export_ics",
            "swarm_schedule",
            BOTH,
            WRITE,
            false,
        ...
        // -- memory capsule --
        row(
            "kernel_memory_capsule_list_recent",
            "memory_capsule",
            IPC,
            PURE,
            false,
        ...
        row(
            "kernel_memory_capsule_suppress_item",
            "memory_capsule",
            IPC,
            WRITE,
            false,
        ...
        row(
            "kernel_memory_capsule_suppress_capsule",
            "memory_capsule",
            IPC,
            WRITE,
            false,
        ...
        row(
            "foreground_exception_window_open",
        ...
        row(
            "kernel_session_get_distill_flag",
            "session_distill",
            IPC,
            PURE,
            false,
        ...
        row(
            "kernel_cli_bridge_clear_config",
            "cli_bridge_config",
            BOTH,
            WRITE,
            false,
        ...
        row(
            "kernel_cli_bridge_list_presets",
            "cli_bridge_config",
            BOTH,
            PURE,
            false,
        ...
        row(
            "kernel_visual_debug_launch_config",
            "visual_debug",
            IPC,
            PURE,
            false,
        ...
        row(
            "kernel_visual_debug_screenshot",
            "visual_debug",
            BOTH,
            PURE,
            false,
        ...
        // -- terminal --
        row(
            "kernel_terminal_create_session",
            "terminal",
            BOTH,
            WF,
            false,
...
#[cfg(feature = "runtime-full")]
fn manual_entry_covering(
    action_id: &str,
) -> Option<&'static crate::model_manual::CommandReference> {
