...
fn ckc_posekit_quickstart_is_native_first_and_reachable() {
    ...
    for required in [
        ...
        "POST /atelier/intake/batches/:batch_id/facial/analyze",
        "quality_source_family",
        "identity_record",
        "identity_model_sha256",
        "identity_provenance",
        "native_feature_outputs",
        "configured model hash is provenance, not proof",
        "native ArcFace tract/ONNX runtime",
        "facial-onnx-runtime",
        "runtime_feature_disabled",
        "runtime_error_counts",
        "arcface_onnx_resize_112_v1",
        "embedding digest/dimensions",
        "HANDSHAKE_FACIAL_ARCFACE_ONNX",
        "model_unavailable",
        "hsk.atelier.facial_review.session@1",
        "content_hash_plus_source_ref",
        "hsk.atelier.facial_review.claim@1",
        "expired claims",
        "hsk.atelier.facial_review.decision@1",
        "pass",
        "accept",
        "unsure",
        "hold",
        "hsk.atelier.facial_review.montage@1",
        "argus://facial-review/",
        "hsk.atelier.facial_review.export@1",
        "source_mutation=false",
        "undecided items block export",
        "Missing content hashes stay singletons",
