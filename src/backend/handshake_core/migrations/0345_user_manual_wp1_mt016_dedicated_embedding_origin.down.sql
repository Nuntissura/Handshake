-- Down-migration for 0345_user_manual_wp1_mt016_dedicated_embedding_origin.sql.

DELETE FROM user_manual_feature_entries WHERE origin = 'wp1_mt016_dedicated_embedding_model';
DELETE FROM user_manual_tool_entries WHERE origin = 'wp1_mt016_dedicated_embedding_model';
