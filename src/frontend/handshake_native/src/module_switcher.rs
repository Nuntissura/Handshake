...
//! ## What this provides
//!
//! A horizontal rail of six pill/tab buttons — `MAIN`, `CKC`, `INGEST`, `STAGE`, `LAB`, `STUDIO` —
...
pub struct ModuleDefinition {
    /// The module identity.
    pub id: ModuleId,
    /// The button label shown in the header (uppercase, same as the React `label`).
...
pub fn pane_type_tab_id(pane_type: &PaneType) -> &'static str {
    match pane_type {
        ...
        PaneType::SwarmLaneDiagnostics => "swarm-lane-diagnostics",
...
mod tests {
    ...
    fn definitions_match_react() {
        ...
        let expected = json!([
            ...
            {
                "id": "CKC", "label": "CKC", "dataId": "module-ckc",
