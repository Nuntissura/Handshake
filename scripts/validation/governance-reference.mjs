 ...
 * - docs/SPEC_CURRENT.md -> "The current authoritative Governance Reference is:" -> **<codex filename>**
 *
...
function printUsageAndExit() {
  console.error("Usage: node scripts/validation/governance-reference.mjs [--print-file|--print-path|--json]");
  process.exit(2);
}
