...
export function SwarmControlRoom() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="swarm-spawn-form__actions">
          <button
            type="submit"
            disabled={spawning}
            data-testid="swarm-spawn-submit"
          >
      ...
      {/* Operator chat box: real generate against a spawned local session */}
      <OperatorChat
        selectedInstanceId={chatInstanceId}
        localSessions={localSessions}
        onSelectInstance={setChatInstanceId}
      />
    </section>
  );
}

function ResourceBar({ snapshot }: { snapshot: SwarmResourceSnapshot }) {
  const pct =
