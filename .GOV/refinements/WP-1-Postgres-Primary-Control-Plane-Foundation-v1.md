...
- USER_APPROVAL_EVIDENCE: <pending> (must equal: APPROVE REFINEMENT WP-1-Postgres-Primary-Control-Plane-Foundation-v1)
...
### GAPS_IDENTIFIED
- Current Master Spec v02.181 still frames PostgreSQL as future-facing or Phase 2/3 in several storage and Locus passages while the operator has explicitly selected an early PostgreSQL-primary control-plane pivot.
...
- SPEC_IMPACT: YES
- SPEC_IMPACT_REASON: Current Master Spec explicitly says PostgreSQL is not Phase 1 in the storage portability section and later treats PostgreSQL as future Locus multi-user work. The operator-directed pivot needs a new normative [ADD v02.182] style spec pass before packet creation can safely proceed.
...
- PRIMITIVES_NEW_OR_UPDATED (IDs):
  - NONE
- NOTES:
  - The foundation WP proposes the new primitive vocabulary for the pivot in `PROPOSED_SPEC_ENRICHMENT`, but this pre-signature refinement only lists existing Appendix 12.4 primitive IDs in the mechanically validated primitive fields.
  - Proposed labels for PostgreSQL-primary control-plane authority, storage mode, SQLite cache/offline boundary, control-plane lease, queue worker, FEMS memory store, workflow durable execution, and DCC projection remain spec-enrichment work until the Master Spec is advanced.

### PRIMITIVE_INDEX (Appendix 12.4: HS-APPX-PRIMITIVE-TOOL-TECH-MATRIX)
- PRIMITIVE_INDEX_ACTION: UPDATED
- PRIMITIVE_INDEX_REASON_NO_CHANGE: N/A
- PRIMITIVE_INDEX_UPDATE_NOTES:
  - Add the PostgreSQL-primary control-plane and storage-mode primitives to the proposed spec enrichment.
  - Keep downstream runtime domain primitives linked to candidate follow-up WP IDs so the foundation does not overclaim implementation coverage; Orchestrator owns stub-file creation and gov_kernel commit.
- HIGH_SIGNAL_ORPHAN_PRIMITIVES_DISCOVERED: PRIM-PostgresPrimaryControlPlane, PRIM-ControlPlaneStorageMode, PRIM-SqliteCacheOfflineBoundary, PRIM-ControlPlaneLease, PRIM-ModelRunQueueWorker, PRIM-FemsPostgresMemoryStore, PRIM-WorkflowPostgresDurableExecution, PRIM-DccPostgresProjection
- HIGH_SIGNAL_ORPHAN_PRIMITIVES_RESOLUTION: MIXED
- HIGH_SIGNAL_ORPHAN_PRIMITIVES_ATTACHED_THIS_PASS: PRIM-PostgresPrimaryControlPlane, PRIM-ControlPlaneStorageMode, PRIM-SqliteCacheOfflineBoundary
- HIGH_SIGNAL_ORPHAN_PRIMITIVES_STUB_WP_IDS: WP-1-Postgres-Control-Plane-Leases-Backpressure-v1, WP-1-ModelSession-Postgres-Queue-Workers-v1, WP-1-FEMS-Postgres-Memory-Store-v1, WP-1-Workflow-Engine-Postgres-Durable-Execution-v1, WP-1-DCC-Postgres-Control-Plane-Projections-v1
- HIGH_SIGNAL_ORPHAN_PRIMITIVES_REASON: The pivot exposes new runtime authority primitives; only the storage-mode and authority-boundary pieces belong in the foundation WP.
...
- FEATURE_REGISTRY_REASON_NO_CHANGE: N/A
...
- INTERACTION_MATRIX_REASON_NO_CHANGE: N/A
- APPENDIX_MAINTENANCE_NOTES:
  - Feature registry and interaction matrix need a PostgreSQL-primary control-plane pivot row and downstream candidate follow-up WP links.
...
- IMX_EDGE_IDS_ADDED_OR_UPDATED: IMX-061, IMX-107, IMX-108, IMX-109, IMX-110, IMX-111
...
- PRIMITIVE_MATRIX_VERDICT: NEEDS_STUBS
- PRIMITIVE_MATRIX_REASON: The matrix found high-ROI downstream edges that are real but separable; seven candidate follow-up WP IDs capture them while Orchestrator owns stub-file creation.
...
- SCAN_SCOPE: Current stubs, official packets, Task Board, WP Traceability Registry, Build Order, current Master Spec v02.181, and product storage/runtime code under `../handshake_main/src/backend/handshake_core`.
- MATCHED_STUBS:
  - Artifact: WP-1-Postgres-Dev-Test-Container-Matrix-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: N/A | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-Postgres-Dev-Test-Container-Matrix-v1 | Notes: downstream developer/test container setup
  - Artifact: WP-1-Postgres-Control-Plane-Leases-Backpressure-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: NONE | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-Postgres-Control-Plane-Leases-Backpressure-v1 | Notes: downstream claim/lease/backpressure semantics
  - Artifact: WP-1-ModelSession-Postgres-Queue-Workers-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: NONE | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-ModelSession-Postgres-Queue-Workers-v1 | Notes: downstream ModelSession queue-worker persistence
  - Artifact: WP-1-FEMS-Postgres-Memory-Store-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: NONE | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-FEMS-Postgres-Memory-Store-v1 | Notes: downstream shared FEMS memory authority
  - Artifact: WP-1-Workflow-Engine-Postgres-Durable-Execution-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: NONE | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-Workflow-Engine-Postgres-Durable-Execution-v1 | Notes: downstream workflow durable execution authority
  - Artifact: WP-1-DCC-Postgres-Control-Plane-Projections-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: PARTIAL | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-DCC-Postgres-Control-Plane-Projections-v1 | Notes: downstream operator projection layer
  - Artifact: WP-1-SQLite-Cache-Offline-Boundaries-v1 | BoardStatus: STUB | Intent: DISTINCT | PrimitiveIndex: MISSING | Matrix: MISSING | UI: NONE | CodeReality: N/A | Resolution: NEW_STUB | Stub: WP-1-SQLite-Cache-Offline-Boundaries-v1 | Notes: downstream fallback/cache boundary
...
- MATCHED_COMPLETED_PACKETS:
  ...
  - Artifact: WP-1-Dev-Command-Center-Control-Plane-Backend-v1 | BoardStatus: VALIDATED | Intent: PARTIAL | PrimitiveIndex: MISSING | Matrix: MISSING | UI: PARTIAL | CodeReality: PARTIAL | Resolution: KEEP_SEPARATE | Stub: NONE | Notes: existing DCC backend is a prerequisite for Postgres-authority projection, not a duplicate.
  - Artifact: WP-1-ModelSession-Core-Scheduler-v1 | BoardStatus: VALIDATED | Intent: PARTIAL | PrimitiveIndex: COVERED | Matrix: MISSING | UI: NONE | CodeReality: IMPLEMENTED | Resolution: KEEP_SEPARATE | Stub: NONE | Notes: core scheduler exists but not Postgres-primary queue-worker authority.
  - Artifact: WP-1-Storage-Trait-Purity-v1 | BoardStatus: VALIDATED | Intent: PARTIAL | PrimitiveIndex: COVERED | Matrix: MISSING | UI: NONE | CodeReality: IMPLEMENTED | Resolution: KEEP_SEPARATE | Stub: NONE | Notes: removes storage trait leakage but does not change default control-plane authority.
  - Artifact: WP-1-Dual-Backend-Tests-v2 | BoardStatus: VALIDATED | Intent: PARTIAL | PrimitiveIndex: COVERED | Matrix: MISSING | UI: NONE | CodeReality: IMPLEMENTED | Resolution: KEEP_SEPARATE | Stub: NONE | Notes: test posture exists but the pivot needs a concrete dev/container matrix.
...
- SPEC_ANCHOR_PRIMARY: Handshake_Master_Spec_v02.181.md storage portability plus v02.181 software-delivery control-plane projection law; requires [ADD v02.182] PostgreSQL-primary pivot enrichment.
- WHAT: Define and implement the minimal PostgreSQL-primary control-plane foundation: spec law, storage-mode/default configuration, explicit authority labels, fail-closed startup behavior, and bootstrap proof that self-hosted control-plane runtime state is not silently SQLite-primary.
...
- TEST_PLAN:
  ...
  ```
- DONE_MEANS:
  - Master Spec enrichment for PostgreSQL-primary control-plane authority is approved and `SPEC_CURRENT` advances before packet coding begins.
...
- CLAUSES_TO_INSPECT:
  ...
  - Current v02.181 storage portability and dual-backend testing law.
- FILES_TO_READ:
...
- DISCOVERY_MATRIX_EDGES: IMX-POSTGRES-CONTROL-PLANE-001, IMX-POSTGRES-CONTROL-PLANE-002, IMX-POSTGRES-CONTROL-PLANE-003
...
- DISCOVERY_SPEC_ENRICHMENT: YES - current Master Spec must be updated because it still frames PostgreSQL as non-Phase-1/future for core storage and Locus posture.
- DISCOVERY_JUSTIFICATION: The operator-directed pivot intentionally yielded downstream candidate follow-up WPs and spec enrichment; Orchestrator owns stub-file creation and zero-discovery does not apply.
...
- CLEARLY_COVERS_REASON: Current Master Spec covers backend portability and has PostgreSQL support language, but it does not clearly say PostgreSQL is now the primary self-hosted control-plane authority or that SQLite fallback is non-authoritative for control-plane writes.
- AMBIGUITY_FOUND: YES
- AMBIGUITY_REASON: Spec v02.181 still contains Phase 1 SQLite and future PostgreSQL framing that conflicts with the operator's current pivot.
...
- Add `IMX-POSTGRES-CONTROL-PLANE-001`: `PRIM-PostgresPrimaryControlPlane -> PRIM-ControlPlaneStorageMode`, kind `authority boundary`, ROI `HIGH`.
- Add `IMX-POSTGRES-CONTROL-PLANE-002`: `PRIM-ControlPlaneStorageMode -> PRIM-SqliteCacheOfflineBoundary`, kind `fail-closed fallback boundary`, ROI `HIGH`.
- Add `IMX-POSTGRES-CONTROL-PLANE-003`: `PRIM-PostgresPrimaryControlPlane -> PRIM-ControlPlaneLease`, kind `concurrency and backpressure authority`, ROI `HIGH`, candidate follow-up `WP-1-Postgres-Control-Plane-Leases-Backpressure-v1`.
```
...
#### ANCHOR 1
- SPEC_ANCHOR: Handshake_Master_Spec_v02.181.md 2.3.13.1 Four Portability Pillars [CX-DBP-002]
- CONTEXT_START_LINE: 3248
- CONTEXT_END_LINE: 3322
- CONTEXT_TOKEN: Even though PostgreSQL is not in Phase 1
- EXCERPT_ASCII_ESCAPED:
  ```text
  Handshake's local-first philosophy requires flexibility to support future migrations from SQLite (local) to PostgreSQL (cloud-optional).
  Pillar 4 says: Even though PostgreSQL is not in Phase 1, test infrastructure MUST be in place to run tests against both SQLite and PostgreSQL in CI.
  The pivot needs enrichment because the operator has now selected PostgreSQL-primary control-plane authority earlier than this text assumes.
  ```

#### ANCHOR 2
- SPEC_ANCHOR: Handshake_Master_Spec_v02.181.md 2.3.15 Locus Work Tracking System storage and projection posture
- CONTEXT_START_LINE: 6680
- CONTEXT_END_LINE: 7060
...
#### ANCHOR 3
- SPEC_ANCHOR: Handshake_Master_Spec_v02.181.md 4.3.9.12-4.3.9.13 ModelSession and Session Scheduler
- CONTEXT_START_LINE: 32267
- CONTEXT_END_LINE: 32460
...
#### ANCHOR 4
- SPEC_ANCHOR: Handshake_Master_Spec_v02.181.md 2.6.6.7.6.2 FEMS and ModelSession memory policy
- CONTEXT_START_LINE: 11851
- CONTEXT_END_LINE: 12000
...
#### ANCHOR 5
- SPEC_ANCHOR: Handshake_Master_Spec_v02.181.md 2.3.5.6 The Role of SQLite
