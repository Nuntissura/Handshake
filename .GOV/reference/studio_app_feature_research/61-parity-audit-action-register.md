...
actions:
  ...
  - id: "ACTION-A7"
    ...
    status: "RESOLVED"
    detail: "Operator decisions recorded 2026-07-21."
    decisions:
      - id: "STUDIO-DEC-001"
        topic: "CJK / RTL / Middle-East market-language scope"
        decision: "IN SCOPE. Full CJK (Japanese/Chinese/Korean), RTL (Arabic/Hebrew bidi), and Middle-East text support are in scope for Studio. This upgrades the four previously market-contingent MAJOR gaps (composite fonts, kinsoku/mojikumi, ruby/warichu/tate-chu-yoko, kashida/bidi/vertical-CJK) to committed research + build targets."
      - id: "STUDIO-DEC-002"
        topic: "iPad / web parity"
        decision: "OUT for now. Studio is a Handshake module; Handshake is LOCAL-ONLY focused for now. If Handshake ever ships a web/iPad version, Studio's tablet/web-surface parity is revisited then. Do not spend research/build effort on iPad/web-specific surfaces now; desktop-class local parity only."
      - id: "STUDIO-DEC-003"
        topic: "Accessible output posture"
        decision: "EXCEED. Studio must exceed the incumbents on accessible output (tagged PDF/UA, semantic web output, EPUB3 accessibility, WCAG/EAA), not merely mirror them. Studio is a native Handshake tool/module/app, built into Handshake."
      - id: "STUDIO-DEC-004"
        topic: "Studio / Handshake positioning and business model"
        decision: "Handshake is built on open source and directly combats vendor paywalls/subscriptions by taking everything OFFLINE at FULL feature parity and professional/industry-grade level. Studio is a native Handshake module (not a separate app, not cloud-dependent, no subscription). This is the product north-star for Studio scope: local-first, offline, full non-AI parity, professional grade, open-source foundation."
    propagation_note: "These are operator decisions recorded as provenance. Promoting STUDIO-DEC-004 (positioning) and the CJK/RTL/accessibility scope into Master Spec Section 14 is a governed spec-enrichment step deferred until the operator resumes refinement (operator declined refinement on 2026-07-21). Until then they steer research scope only."
  - id: "ACTION-A8"
