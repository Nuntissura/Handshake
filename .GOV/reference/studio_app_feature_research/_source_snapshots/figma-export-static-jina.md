Title: Export static designs from Figma

URL Source: https://help.figma.com/hc/en-us/articles/360040028114-Export-static-designs-from-Figma
...
[Video 3](https://www.youtube.com/watch?v=Wcymrndn9U8)
...
![Image 1: An animation that shows the user creating a slice around for button frames on the canvas.](https://help.figma.com/hc/article_attachments/29127905488535)
...
![Image 2: With can view access, all of the editor options in the right sidebar are removed.](https://help.figma.com/hc/article_attachments/29127905491223)

### Dev Mode

If you are using Dev Mode, the **Export**section is located in the right sidebar, but is only visible if you have an object selected. Learn how to [export or download assets in Dev Mode](https://help.figma.com/hc/en-us/articles/22012921621015#h_01JWYBRK4VGF5BAPSN9XMQ6GDZ).
...
1.   (Optional) Click **Preview** to see how your asset will look. If you have multiple objects selected, the **Preview** setting does not display.
2.   Click **Export**.

I f you’re using Figma in the browser, the exported file will be sent to the download location set in your browser’s preferences. If you’re using the Figma desktop app, you are prompted to rename the file and choose where to send the export.
