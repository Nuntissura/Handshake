...
URL Source: https://developer.adobe.com/photoshop/uxp/2022/ps-reference/
...
An important difference between ExtendScript (and CEP) and UXP in Photoshop is that all ExtendScript calls to Photoshop were synchronous. This means they blocked the Photoshop UI while they were executing. In UXP, a method call is _asynchronous_, and does not block the UI thread.
...
Through the [`app`](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/#overview "app") object, you can access the rest of Photoshop's objects and methods.
...
See more properties and methods in `app` under [Photoshop](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/photoshop "Photoshop").
...
As you may notice, this restriction could encompass much of your plugin's functionality! There are many benefits for this model, however. A more detailed explanation is provided in the [Execute as Modal documentation](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/media/executeasmodal "Execute as Modal documentation").
...
See more properties and methods regarding `Document` under [Document](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/document "Document") and [Documents](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/documents "Documents").

Represents a Layer, or a group of Layers. This object is tied to a particular [Document](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/#Document "Document").
...
See more properties and methods for `Layer` under [Layer](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/layer "Layer") and [Layers](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/layers "Layers").
...
Similarly to Actions, the ActionSet object allows you to delete, duplicate, rename, and play Action Sets. There is no current way to _create_ an Action Set.
...
See more properties and methods for `Action` under [Action](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/action "Action") and [ActionSet](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/classes/actionset "ActionSet")
...
The [batchPlay documentation](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/media/batchplay "batchPlay documentation") contains details on how to construct JSON for `batchPlay` usage.

UXP is not just for plugins anymore. Individual JavaScript files may be developed and executed as detailed in the [UXP Scripting section](https://developer.adobe.com/photoshop/uxp/2022/ps-reference/media/uxpscripting "UXP Scripting section").
