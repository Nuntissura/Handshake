...
const ACTIVE_SPEC_VERSION = "v02.205";
const ACTIVE_SPEC_ENTRYPOINT = ".GOV/spec/master-spec-v02.205/indexed-spec-manifest.json";
...
const nativeSupersessions = {
  ...
  "MT-651": "Author the BodyKit UserManual for the v02.205 native runtime, GNM-v3 provider, dependency bundles, project/body/face/anatomy/performance workflows, GLB/restricted USD delivery, optional Unreal, manual Blender and typed unsupported recovery.",
...
function newMt({ number, group, summary, deps, paths, criteria, proof, risk, gui = null, manualChapter = null }) {
  ...
  return {
    ...
    resource_privacy_obligation: {
      ...
      requirements: ["Resolve Principal, AuthenticatedSession and AccessSpace before every resource read or mutation.", "Use authenticated SurrealDB record-user table/field permissions and ResourceBroker-backed artifact/file handles; UI filtering is never the security boundary.", "Derived resources preserve the intersection of source access scopes and must not leak existence through counts, search, previews, logs, traces, caches, diagnostics, exports or model context."],
...
const index = {
  ...
  note: "Pre-activation projection of all 842 inactive machine-readable MT contracts under active Master Spec v02.205. MT-001..782 are preserved and reconciled; MT-783..842 add BodyKit-v2 native runtime, providers, cinematic production, interchange, professional UI, privacy/pillars and final proof. This index is not execution or validator authority.",
...
const technicalRefinement = {
  ...
  approved_spec_enrichment: [
    ...
    "Professional native top-bar, workspace, tool, slider-plus-numeric, viewport, graph, timeline, jobs, problems, history and model-navigation contracts; SurrealDB-exclusive authority, parallel projects, scoped CRDT, HBR-PRIV, Loom/Locus/Flight Recorder."
  ],
  ...
  scope_edges: [
    ...
    "Handshake-managed SurrealDB persists EventLedger authority; ArtifactStore owns derived artifacts; Flight Recorder is a projection; optional pillars never become Tailor authority; PostgreSQL and SQLite are forbidden.",
  ...
  assumptions: [
    ...
    "The Master Spec approval signature was consumed only for v02.205 enrichment; WP activation still requires the Classic Orchestrator/Activation Manager lane and separate activation authority."
  ],
  non_goals: [
  ...
  spec_anchors: ["Master Spec v02.205 Section 13.1..13.45", "TAI-V2-RUN-001..010", "TAI-V2-BDY-001..012", "TAI-V2-PERF-001..010", "TAI-V2-IO-001..010", "TAI-V2-PRJ-001..010", "TAI-V2-ACT-001..007", "TAI-V2-UX-001..012", "TAI-V2-QA-001..009", "TAI-V2-RES-001..003", "HANDSHAKE_BUILD_RULES HBR-INT/HBR-SWARM/HBR-VIS/HBR-QUIET/HBR-MAN/HBR-STOP/HBR-PRIV", "WP-KERNEL-012 native shell and Atelier/PoseKit contracts", "PRIM-UserManual", "KernelActionCatalogV1", "EventLedger", "ArtifactStore", "Flight Recorder", "Palmistry", "Locus", "Loom/ProjectKnowledgeIndex"],
  ...
  acceptance_criteria: [
    ...
    "The active v02.205 bundle is the sole product authority; this refinement and MT set remain non-execution until official packet hydration, dependency containment, product worktree/state synchronization and explicit Activation Manager readiness."
  ],
  hbr_pillar_review: {
  ...
  absorbed_preworks: {
    ...
    preservation_rule: "No prior MT intent or research is deleted. Active v02.205 wins on conflict; retained preworks preserve provenance only."
  },
  ...
  legacy_law_reconciliation: {
    ...
    "python_blender_fbx_alembic": { owner_mts: Object.keys(nativeSupersessions), contract: "The listed legacy MTs are preservation-first rewritten to active v02.205 Rust/no-Python/canonical-interchange law.", status: RECONCILIATION_STATUS }
  },
  research_basis: {
    ...
    reuse_opportunities: ["KernelActionCatalogV1", "EventLedger", "SurrealDB authenticated record-user permissions", "ResourceBroker", "ArtifactStore", "Flight Recorder", "Palmistry", "UserManual", "native shell/Argus/AccessKit", "Locus", "Loom", "Atelier/PoseKit/character sheets", "shared renderer/scheduler/leases/jobs"],
  ...
  red_team: {
    ...
    minimum_controls: ["Python/cloud/firewall and adapter-removal gates.", "Immutable dependency/provider/interchange profiles.", "Exact action/surface/manual registries.", "SurrealDB/EventLedger/ArtifactStore authority and HBR-PRIV negative tests.", "PostgreSQL/SQLite dependency, connectivity, fixture, cache, fallback, import, reconciliation and proof-path tripwires.", "Direct/inherited/not-applicable diagnostics.", "Measured profiles and typed unsupported behavior.", "Frame plus sequence direct inspection.", "No-context, fault, concurrency, recovery, accessibility and DCC qualification evidence."]
  },
...
stub.lifecycle.spec_status = "Master Spec v02.205 Sections 13.1..13.45 and Appendix 12 are active and validated; execution remains blocked on official packet hydration, separate WP activation authority, dependency containment/current-main compatibility, product worktree/state synchronization and Activation Manager readiness.";
...
stub.microtasks.shape = "All MT-001..842 follow hsk.microtask_contract@1; all remain PENDING and active=false. MT-001..782 are preserved/reconciled and MT-783..842 implement v02.205 BodyKit-v2. Every MT has at least three acceptance criteria, task-oriented UserManual targets, HBR-PRIV/resource privacy, classified diagnostics and an acyclic candidate DAG. This is non-execution refinement pending official packet hydration and activation.";
...
stub.microtasks.reconciliation = `${REVIEW_PATH} reviews MT-001..842; prior MT-001..782 scope is preserved and incompatible Python/Blender/FBX/Alembic assumptions are explicitly superseded by active v02.205. This remains non-execution authority.`;
...
stub.refinement_ready.mt_group_plan.source = "active Master Spec v02.205, preserved MT-001..782, research and independent runtime/UI/pillar audits, plus MT-783..842 BodyKit-v2 closure lanes";
stub.refinement_ready.spec_authority = "Master Spec v02.205 is normative: Section 13.1..13.36 preserves Cloth/BodyKit professional law and Sections 13.37..13.45 supersede incompatible runtime/interchange details with the approved BodyKit-v2 authority.";
...
stub.refinement_ready.next_session_steps = [
  "1. Pass the v02.205 Tailor semantic/preactivation and repository governance gates over MT-001..842.",
...
stub.activation_status.lifecycle = "REFINEMENT_APPROVED / NON_EXECUTION_STUB (HELD — v02.205 contract candidate, not packet-hydrated or activated)";
...
stub.activation_status.microtasks.note = "MT-001..782 preserve the prior Cloth/BodyKit plan with v02.205 supersessions; MT-783..842 add native runtime, providers, cinematic output, interchange, professional workspaces, privacy/pillars and final proof. All are PENDING and active=false.";
...
stub.activation_status.spec_enrichment = {
  ...
  refinement_approval_evidence: "Operator approved the researched Tailor/BodyKit-v2 vision; v02.205 changelog and SIGNATURE_AUDIT record the governed enrichment.",
