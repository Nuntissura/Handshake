...
export const ROLE_MODEL_PROFILE_OPENAI_CODEX_SPARK_5_3_HIGH = "OPENAI_CODEX_SPARK_5_3_HIGH";
...
export const ROLE_MODEL_PROFILE_CATALOG = Object.freeze({
  ...
  [ROLE_MODEL_PROFILE_OPENAI_CODEX_SPARK_5_3_HIGH]: Object.freeze({
    profile_id: ROLE_MODEL_PROFILE_OPENAI_CODEX_SPARK_5_3_HIGH,
    provider: "OPENAI",
    session_tool: CLI_SESSION_TOOL,
    runtime_support: ROLE_MODEL_PROFILE_RUNTIME_SUPPORTED,
    ...
    launch_reasoning_config_key: ROLE_SESSION_REASONING_CONFIG_KEY,
    launch_reasoning_config_value: "high",
    reasoning_policy_note: `${ROLE_SESSION_REASONING_CONFIG_KEY}=high (Codex Spark: fast coder, lower reasoning cost)`,
...
export const DEFAULT_ROLE_MODEL_PROFILE_IDS = Object.freeze({
  ORCHESTRATOR: ROLE_MODEL_PROFILE_CLAUDE_CODE_OPUS_4_6_THINKING_MAX,
  CODER: ROLE_MODEL_PROFILE_OPENAI_CODEX_SPARK_5_3_HIGH,
  WP_VALIDATOR: ROLE_MODEL_PROFILE_CLAUDE_CODE_OPUS_4_6_THINKING_MAX,
  INTEGRATION_VALIDATOR: ROLE_MODEL_PROFILE_CLAUDE_CODE_OPUS_4_6_THINKING_MAX,
});
export const ROLE_MODEL_PROFILE_FALLBACKS = Object.freeze({
  ...
  [ROLE_MODEL_PROFILE_OPENAI_CODEX_SPARK_5_3_HIGH]: ROLE_MODEL_PROFILE_OPENAI_GPT_5_2_XHIGH,
});
