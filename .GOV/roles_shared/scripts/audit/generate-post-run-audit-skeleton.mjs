...
function buildLiveReview({
  ...
  return [
    ...
    "  - NONE",
    "- SCOPE:",
    `  - workflow dossier opened at WP activation for \`${packetPath}\`; role memories are imported at closeout`,
    ...
    "|---|---|",
    `| ${formatLocalTimestamp(now)} | Workflow dossier created at WP activation |`,
