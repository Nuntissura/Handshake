...
function usage() {
  console.error("Usage: node .GOV/roles_shared/scripts/dev/new-api-endpoint.mjs <endpoint_name>");
  console.error("Example: node .GOV/roles_shared/scripts/dev/new-api-endpoint.mjs canvas_ping");
}
