...
- `.GOV/scripts/hooks/pre-commit` - Git hook
...
**File**: `.GOV/scripts/hooks/pre-commit`
...
3. Create `.GOV/scripts/hooks/pre-commit` (wire codex-check + lint + tests)
4. Wire hook: `git config core.hooksPath .GOV/scripts/hooks`
...
7) Add git hook (`.GOV/scripts/hooks/pre-commit`) for invariants and linting.
