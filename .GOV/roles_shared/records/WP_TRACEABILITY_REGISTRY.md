...
| WP-1-FR-ModelSessionId | .GOV/task_packets/stubs/WP-1-FR-ModelSessionId-v1.md | Stub Backlog (Not Activated): WP-1-FR-ModelSessionId-v1 | stub (audit remediation); add model_session_id to FR envelope + DuckDB |
...
| WP-1-Spec-Enrichment-LLM-Core | .GOV/task_packets/WP-1-Spec-Enrichment-LLM-Core-v1.md | Ready for Dev: WP-1-Spec-Enrichment-LLM-Core-v1 | active=WP-1-Spec-Enrichment-LLM-Core-v1 |
| WP-1-Spec-Enrichment-MT-ContextPack-Defaults | .GOV/task_packets/WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2.md | Ready for Dev: WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2 | active=WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2 |
...
| WP-1-Storage-Trait-Purity | .GOV/task_packets/stubs/WP-1-Storage-Trait-Purity-v1.md | Stub Backlog (Not Activated): WP-1-Storage-Trait-Purity-v1 | stub (audit remediation); remove downcast escape hatches |
