...
| WP-1-Calendar-Storage | .GOV/task_packets/stubs/WP-1-Calendar-Storage-v2.md | Stub Backlog (Not Activated): WP-1-Calendar-Storage-v2 | stub (supersession); supersedes: WP-1-Calendar-Storage-v1 (implemented but never validated, spec-stale v02.141, old refinement workflow without primitive mixing); v2 scheduled for later Phase 1 stages; calendar is a pillar feature requiring cross-cutting primitive discovery |
| WP-1-Calendar-Sync-Engine | .GOV/task_packets/stubs/WP-1-Calendar-Sync-Engine-v1.md | Stub Backlog (Not Activated): WP-1-Calendar-Sync-Engine-v1 | stub (audit remediation); calendar_sync mechanical runner |
...
| WP-1-Distillation | .GOV/task_packets/stubs/WP-1-Distillation-v2.md | Stub Backlog (Not Activated): WP-1-Distillation-v2 | stub (spec v02.157); late-stage distillation/adapter lineage, eval gating, and LoRA/QLoRA/DoRA promotion discipline; supersedes: WP-1-Distillation |
...
| WP-1-Governance-Workflow-Mirror | .GOV/task_packets/stubs/WP-1-Governance-Workflow-Mirror-v1.md | Stub Backlog (Not Activated): WP-1-Governance-Workflow-Mirror-v1 | stub (current focus); mirror the imported software-delivery governance overlay inside Handshake runtime without replacing Handshake-native governance |
