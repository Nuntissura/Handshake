...
- **[WP-1-Postgres-Dev-Test-Container-Matrix-v1]** - [SUPERSEDED]
- **[WP-1-Postgres-Control-Plane-Leases-Backpressure-v1]** - [SUPERSEDED]
- **[WP-1-ModelSession-Postgres-Queue-Workers-v1]** - [SUPERSEDED]
- **[WP-1-FEMS-Postgres-Memory-Store-v1]** - [SUPERSEDED]
- **[WP-1-Workflow-Engine-Postgres-Durable-Execution-v1]** - [SUPERSEDED]
- **[WP-1-DCC-Postgres-Control-Plane-Projections-v1]** - [SUPERSEDED]
- **[WP-1-SQLite-Cache-Offline-Boundaries-v1]** - [SUPERSEDED]
- **[WP-1-Governance-Pack-v1]** - [SUPERSEDED]
- **[WP-1-Software-Delivery-Governance-Overlay-Boundary-v1]** - [SUPERSEDED]
- **[WP-1-Software-Delivery-Runtime-Truth-v1]** - [SUPERSEDED]
- **[WP-1-Software-Delivery-Overlay-Coordination-Records-v1]** - [SUPERSEDED]
- **[WP-1-Software-Delivery-Overlay-Lifecycle-Recovery-Control-Plane-v1]** - [SUPERSEDED]
- **[WP-1-Locus-Work-Tracking-System-Phase1-v1]** - [SUPERSEDED]
- **[WP-1-LocalFirst-Agentic-MCP-Posture-v1]** - [SUPERSEDED]
- **[WP-1-Work-Profiles-v1]** - [SUPERSEDED]
- **[WP-1-FEMS-Memory-Poisoning-Drift-Guardrails-v1]** - [SUPERSEDED]
- **[WP-1-FEMS-Write-Time-Safeguards-v1]** - [SUPERSEDED]
- **[WP-1-FEMS-Working-Memory-Checkpoint-Schema-v1]** - [SUPERSEDED]
- **[WP-1-FEMS-MT-Handoff-Memory-Context-v1]** - [SUPERSEDED]
- **[WP-1-Inbox-Role-Mailbox-Alignment-v1]** - [SUPERSEDED]
- **[WP-1-Session-Anti-Pattern-Registry-v1]** - [SUPERSEDED]
- **[WP-1-Workflow-Transition-Automation-Registry-v1]** - [SUPERSEDED]
- **[WP-1-Markdown-Mirror-Sync-Drift-Guard-v1]** - [SUPERSEDED]
- **[WP-1-Dev-Command-Center-MVP-v1]** - [SUPERSEDED]
- **[WP-1-Dev-Command-Center-Layout-Projection-Registry-v1]** - [SUPERSEDED]
- **[WP-1-Dev-Command-Center-Structured-Artifact-Viewer-v1]** - [SUPERSEDED]
- **[WP-1-Role-Turn-Isolation-v1]** - [SUPERSEDED]
- **[WP-1-Git-Engine-Decision-Gate-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Debug-Bundle-Bridge-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Message-Thread-Contract-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Micro-Task-Loop-Control-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Triage-Queue-Controls-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Executor-Routing-Claim-Lease-v1]** - [SUPERSEDED]
- **[WP-1-Role-Mailbox-Handoff-Bundle-Transcription-Announce-Back-v1]** - [SUPERSEDED]
- **[WP-1-Product-Screenshot-Visual-Validation-v1]** - [SUPERSEDED]
