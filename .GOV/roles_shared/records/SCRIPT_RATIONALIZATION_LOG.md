...
| 2026-04-08T10:57:35Z | PLANNED | MERGE_ARCHIVE_SOURCE | `.GOV/roles/orchestrator/tests/orchestrator-command-surface.test.mjs` | test | `governance-command-contract.test.mjs` | low-value command-name meta test | `AUDIT_20260408_GOVERNANCE_SCRIPT_FAMILY_RATIONALIZATION_PLAN.md` | `TBD` | merge with doc/surface tests, then archive source |
| 2026-04-08T10:57:35Z | PLANNED | MERGE_ARCHIVE_SOURCE | `.GOV/roles/orchestrator/tests/orchestrator-doc-command-surface.test.mjs` | test | `governance-command-contract.test.mjs` | low-value doc command reference test | `AUDIT_20260408_GOVERNANCE_SCRIPT_FAMILY_RATIONALIZATION_PLAN.md` | `TBD` | merge with command-surface tests, then archive source |
| 2026-04-08T10:57:35Z | PLANNED | MERGE_ARCHIVE_SOURCE | `.GOV/roles_shared/tests/justfile-gov-root-quoting.test.mjs` | test | `governance-command-contract.test.mjs` | narrow quoting assertion better covered in one contract suite | `AUDIT_20260408_GOVERNANCE_SCRIPT_FAMILY_RATIONALIZATION_PLAN.md` | `TBD` | keep quoting assertion, archive separate file after merge |
| 2026-04-08T10:57:35Z | PLANNED | MERGE_ARCHIVE_SOURCE | `.GOV/roles_shared/tests/protocol-alignment-check.test.mjs` | test | `governance-command-contract.test.mjs` or broader alignment suite | single-command success probe | `AUDIT_20260408_GOVERNANCE_SCRIPT_FAMILY_RATIONALIZATION_PLAN.md` | `TBD` | avoid tiny one-off test files; archive after merge |
| 2026-04-08T10:57:35Z | PLANNED | MERGE_ARCHIVE_SOURCE | `.GOV/roles_shared/tests/cwd-agnostic-packet-checks.test.mjs` | test | `cwd-agnostic-shared-checks.test.mjs` or broader runtime portability suite | overlaps the broader cwd/runtime portability coverage | `AUDIT_20260408_GOVERNANCE_SCRIPT_FAMILY_RATIONALIZATION_PLAN.md` | `TBD` | preserve packet checks within merged suite, then archive source |
