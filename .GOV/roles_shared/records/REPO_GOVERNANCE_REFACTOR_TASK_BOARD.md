...
| RGF-48 | READY | Rolling Microtask Validator Overlap and Backpressure | RGF-47 | `AUDIT-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1-SMOKETEST-STARTUP-REVIEW` / `SMOKETEST-REVIEW-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1` | direct-review receipt schemas, microtask exchange helpers, `roles/coder/CODER_PROTOCOL.md`, `roles/validator/VALIDATOR_PROTOCOL.md`, runtime waiting/next-actor projection | completed microtasks can enter a bounded validator-review loop while the coder advances the next declared microtask, and unresolved validator findings can block, reroute, or narrow subsequent microtask work before debt accumulates |
| RGF-49 | READY | Validator-Owned Bootstrap and Skeleton Gate | RGF-47 | `AUDIT-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1-SMOKETEST-STARTUP-REVIEW` / `SMOKETEST-REVIEW-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1` | startup/launch governance, `roles/orchestrator/ORCHESTRATOR_PROTOCOL.md`, `roles/coder/CODER_PROTOCOL.md`, `roles/validator/VALIDATOR_PROTOCOL.md`, direct-review lane routing | governed WPs cannot leave bootstrap or skeleton on coder say-so alone; the WP Validator must explicitly assess bootstrap/skeleton quality and early coder-validator communication before the lane advances |
| RGF-50 | READY | LLM-First Data Contract Codification | RGF-49 | `AUDIT-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1-SMOKETEST-STARTUP-REVIEW` / `SMOKETEST-REVIEW-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1` | packet/spec templates, `roles/coder/CODER_PROTOCOL.md`, `roles/validator/VALIDATOR_PROTOCOL.md`, audit rubrics, data-surface proof fields | data-bearing Handshake WPs must declare and review a codified data contract covering SQL posture, PostgreSQL readiness, LLM-first readability/parseability, and Loom-intertwined requirements instead of leaving those qualities implicit |
| RGF-51 | READY | Anti-Vibe Review Heuristics and Zero-Debt Rejection | RGF-48, RGF-49, RGF-50 | `AUDIT-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1-SMOKETEST-STARTUP-REVIEW` / `SMOKETEST-REVIEW-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1` | validator rubrics/reports, coder handoff schema, audit template, review exchange helpers | shallow easy-surface work, weakly justified implementation, vibe-coded changes, and accepted signed-scope debt become explicit review failures or `NOT_PROVEN` truth, and PASS cannot coexist with unresolved implementation-quality debt inside signed scope |
