...
| RGF-47 | READY | Contract-Heavy Mid-Session Validator Checkpoint Discipline | RGF-31, RGF-40 | `AUDIT-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1-SMOKETEST-STARTUP-REVIEW` / `SMOKETEST-REVIEW-20260331-PROJECT-PROFILE-EXTENSION-REGISTRY-V1` | direct-review helpers, validator protocol/rubrics, communication-health rules, coder-handoff discipline | contract-heavy WPs gain an explicit short validator checkpoint between `CODER_INTENT` and full `CODER_HANDOFF` when signed surfaces or proof obligations are under-specified, reducing late-loop rework and false completion claims |
