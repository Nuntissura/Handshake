...
Every qualifying review must score all three core targets plus the two operational targets:

1. Workflow Smoothness
2. Master Spec Gap Reduction
3. Token Cost Pressure
4. Communication Maturity (new)
5. Terminal and Session Hygiene (new)
...
### Communication Maturity (0-10) — NEW
...
### Terminal and Session Hygiene (0-10) — NEW
