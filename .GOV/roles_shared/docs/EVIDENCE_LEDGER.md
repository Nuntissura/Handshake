...
The canonical evidence for a WP lives INSIDE the resolved Work Packet (append-only):
- Path: logical `/.GOV/work_packets/{WP_ID}/packet.md`; current physical storage `/.GOV/task_packets/{WP_ID}/packet.md`; legacy flat compatibility `/.GOV/task_packets/{WP_ID}.md`
