...
- Use `manifests/restore_instructions.txt` and `.GOV/roles_shared/OFFLINE_GIT_BACKUP_SETUP.md` as the operator playbook

## Reusable Guide

The reusable setup guide lives at:

- `.GOV/roles_shared/OFFLINE_GIT_BACKUP_SETUP.md`
