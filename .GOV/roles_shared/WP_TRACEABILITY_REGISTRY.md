...
| WP-1-Spec-Router-SpecPromptCompiler | .GOV/task_packets/stubs/WP-1-Spec-Router-SpecPromptCompiler-v1.md | Stub Backlog (Not Activated): WP-1-Spec-Router-SpecPromptCompiler-v1 | stub (spec v02.139); Phase 1 Prompt->Spec hardening item 1/3: deterministic SpecPromptPack + SpecPromptCompiler pipeline |
