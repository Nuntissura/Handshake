...
| WP-1-Locus-Phase1-Integration-Occupancy | .GOV/task_packets/stubs/WP-1-Locus-Phase1-Integration-Occupancy-v1.md | Stub Backlog (Not Activated): WP-1-Locus-Phase1-Integration-Occupancy-v1 | stub (audit remediation); Spec Router + MT executor wiring + occupancy |
...
| WP-1-Calendar-Storage | .GOV/task_packets/stubs/WP-1-Calendar-Storage-v1.md | Stub Backlog (Not Activated): WP-1-Calendar-Storage-v1 | stub (audit remediation); portable storage + migrations |
...
| WP-1-Postgres-MCP-Durable-Progress | .GOV/task_packets/stubs/WP-1-Postgres-MCP-Durable-Progress-v1.md | Stub Backlog (Not Activated): WP-1-Postgres-MCP-Durable-Progress-v1 | stub (audit remediation); Postgres MCP durable progress mapping |
...
| WP-1-Autonomous-Governance-Protocol | .GOV/task_packets/WP-1-Autonomous-Governance-Protocol-v2.md | In Progress: WP-1-Autonomous-Governance-Protocol-v2 | active=WP-1-Autonomous-Governance-Protocol-v2; activated from stub .GOV/task_packets/stubs/WP-1-Autonomous-Governance-Protocol-v1.md; anchored to spec v02.132 |
