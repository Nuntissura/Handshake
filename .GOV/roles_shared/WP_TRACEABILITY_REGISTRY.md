...
| WP-1-LLM-Provider-Registry | .GOV/task_packets/WP-1-LLM-Provider-Registry-v1.md | Ready for Dev: WP-1-LLM-Provider-Registry-v1 | active=WP-1-LLM-Provider-Registry-v1; activated from stub .GOV/task_packets/stubs/WP-1-LLM-Provider-Registry-v1.md |
| WP-1-Model-Onboarding-ContextPacks | .GOV/task_packets/WP-1-Model-Onboarding-ContextPacks-v1.md | Ready for Dev: WP-1-Model-Onboarding-ContextPacks-v1 | active=WP-1-Model-Onboarding-ContextPacks-v1; activated from stub .GOV/task_packets/stubs/WP-1-Model-Onboarding-ContextPacks-v1.md |
| WP-1-Spec-Enrichment-Product-Governance-Consistency | .GOV/task_packets/WP-1-Spec-Enrichment-Product-Governance-Consistency-v1.md | Ready for Dev: WP-1-Spec-Enrichment-Product-Governance-Consistency-v1 | active=WP-1-Spec-Enrichment-Product-Governance-Consistency-v1; activated from stub .GOV/task_packets/stubs/WP-1-Spec-Enrichment-Product-Governance-Consistency-v1.md |
| WP-1-Spec-Enrichment-MT-ContextPack-Defaults | .GOV/task_packets/WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2.md | Ready for Dev: WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2 | active=WP-1-Spec-Enrichment-MT-ContextPack-Defaults-v2; post-enrichment packet anchored to v02.126; supersedes: N/A (no prior packet) |
