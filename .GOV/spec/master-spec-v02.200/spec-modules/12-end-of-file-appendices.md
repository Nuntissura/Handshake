...
body_sha256: "db4ef49ac63b87b064a8ddf3e1dc03376a117851363cb7e3e9a86f8a66ad9fdc"
...
```json
{
  ...
  "features": [
    ...
    },
    {
      ...
      "notes": "[ADD v02.198] Appendix backfill: Section 13 (Tailor) activated in v02.194 without appendix rows — recorded now as part of the v02.198 two-submodule expansion. MD-parity garment engine: XPBD GPU solver, pattern/seam authoring, fabric models, collision (exaggerated proportions), trims, UV/texture, animation, auto-fit, model-first MCP surface (six core tools + registered extensions), export lanes (glTF/Alembic-shim/USD/OBJ; FBX via Blender-bridge only). Second-pass parity CG-01..29 closed by MT-449..477."
    },
    {
...
```json
{
  ...
  "feature_links": [
    ...
    },
    {
      ...
      "coverage_status": "SEEDED",
      "coverage_refs": [
        ".GOV/spec/master-spec-v02.198/spec-modules/13-tailor-cloth-garment-engine.md (13.1-13.15)",
        ".GOV/task_packets/WP-KERNEL-010-Tailor-Cloth-Garment-Engine-v1/_MT_INDEX.json (MT-001..477)"
      ],
      "gap_stub_ids": []
    },
    {
      ...
      "coverage_status": "SEEDED",
      "coverage_refs": [
        ".GOV/spec/master-spec-v02.198/spec-modules/13-tailor-cloth-garment-engine.md (13.16-13.27)",
        ".GOV/task_packets/WP-KERNEL-010-Tailor-Cloth-Garment-Engine-v1/_MT_INDEX.json (MT-478..653)",
...
```json
{
  ...
  "ui_guidance": [
    ...
    {
      "feature_id": "FEAT-TAILOR-CLOTH",
      "user_goal": "Author, drape, iterate, and export garments in the Tailor pane: 2D patterns and 3D drape stay live-linked; models and the operator steer the same surfaces.",
      "entry_points": [
        "Tailor pane (native shell pane type 'tailor')",
        "Garment/fabric/trim library browser",
        "Deep links by garment_id from validation and export evidence"
      ],
      "required_surfaces": [
        "ui",
        "backend",
      ...
      "telemetry": [
        "Every mutation emits Tailor* EventLedger events; captures registered in tailor_captures; export manifests hashed."
      ],
      "tests": [
        "Argus headless inspect/steer of viewport, UV editor, library browser; capture matrix incl. edge states (HBR-VIS)."
      ]
    },
    {
      "feature_id": "FEAT-TAILOR-BODYKIT",
      "user_goal": "Build bodies by decoupled region channels (tits/shoulders/hips/thighs/midriff/genitals independent), hit exact measurements, pose, and export to Blender/UE without couplings fighting back.",
      "entry_points": [
        "BodyKit tab of the Tailor pane",
        "Archetype/recipe browser (ARCH-A..H seeds)",
        "Deep links by body_id / recipe_id"
      ],
      "required_surfaces": [
        "ui",
        "backend",
      ...
      "telemetry": [
        "TAILOR_BODY_* events for every channel/recipe/genital/export mutation; QA matrices persisted as validation records + captures."
      ],
      "tests": [
        "Argus drives channel sliders/genital config/measurement panel headlessly; archetype visual capture set; decouple-proof matrix green."
      ]
    }
  ]
}
