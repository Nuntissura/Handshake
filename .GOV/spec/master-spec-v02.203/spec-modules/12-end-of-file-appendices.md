...
spec_version: "v02.203"
bundle_id: "master-spec-v02.203"
module_id: "12"
section_id: "12"
...
body_sha256: "aed64071c7856f3c31586fd49167b87d26edb7573091f7aa9a39a63ce23bb5bd"
...
```json
{
  ...
  "features": [
    ...
    },
    {
      ...
      "notes": "[ADD v02.185] Kernel V1 pre-promotion CRDT workspace edits route through KernelActionCatalogV1 and WriteBoxV1; direct authoritative edits are denied with durable evidence; promotion into Postgres EventLedger authority requires explicit validation, idempotency, stale-state checks, and replayable receipts."
    },
    {
...
```json
{
  ...
  "edges": [
    ...
    },
    {
      ...
      "scope": "normative",
      "tokens": ["PostgreSQL RLS", "ResourceBroker", "derived-scope intersection", "HBR-PRIV-001..008", "negative non-disclosure tests"],
...
- `PRIM-ProjectKnowledgeIndex`: PostgreSQL/EventLedger authority substrate for indexed project roots, sources, spans, entities, relationships, claims, passages, rich documents, UserManual entries, retrieval traces, validation receipts, and projections.
