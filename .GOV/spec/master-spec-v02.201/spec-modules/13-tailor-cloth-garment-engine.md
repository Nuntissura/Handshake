...
body_sha256: "5b37851a23baac47e0c14d71bbce20984b2e7f0bc1b5d9b5375b1a343e47c948"
...
table MUST be preceded by a `guard_authority_write(AuthorityMode::PostgresPrimary)` call enforcing the
...
payload, solver input and Postgres authority JSONB stored in `tailor_garments.spec_json`. It MUST
...
`bodykit_*` table MUST be preceded by `guard_authority_write(AuthorityMode::PostgresPrimary)`
