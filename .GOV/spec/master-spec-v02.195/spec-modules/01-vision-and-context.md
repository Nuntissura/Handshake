...
body_sha256: "350d973acebe77565e249ce57411408f4d6cc9ef22995768f52b51088ce05b03"
...
> 
> **Tech Stack Decision (v02.195 native-GUI pivot, Codex §0A [CX-008-VIS]):** Native Rust GUI (no webview substrate; not Tauri/Electron) + Rust coordinator/backend + Python (AI backend). SUPERSEDED: the prior Tauri + React + TypeScript front-end is retained only as migration/parity reference.
> 
...
| Decision | Choice | Why |
|----------|--------|-----|
| Desktop Shell | **Native Rust GUI** (no webview; not Tauri/Electron) | one bundled installer, fully user-owned; native rendering; supersedes the prior Tauri shell [§0A CX-008-VIS] |
