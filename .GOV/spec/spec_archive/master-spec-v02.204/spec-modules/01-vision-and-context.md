...
body_sha256: "57274f585a488eb7f6a0de601ad849b16549dcb7497cc029190ca65a9ced620e"
...
>
> **Data Authority Decision (v02.204):** Handshake-managed SurrealDB is the sole durable product authority, accessed through the official Rust SDK and Handshake storage boundaries. EventLedger remains the canonical append/replay semantic contract. PostgreSQL is not a runtime dependency, fallback, parallel authority, or validation target; it may be read only by the bounded legacy-import path during cutover.
> 
