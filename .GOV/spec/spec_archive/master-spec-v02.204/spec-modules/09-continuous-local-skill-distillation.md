...
body_sha256: "72be5ac9b61e0f7b08631915424971b04568a164c9dabdbeffc862aba722e19f"
...
SurrealDB is the only authority target. Records MUST be typed `SCHEMAFULL` definitions; nested values use typed object/array fields. Initialize EventLedger persistence and all authority records from an empty SurrealDB schema and cold activation. SQLite/PostgreSQL connectivity, inputs, importers, dependencies, configuration, fixtures, tests, and proof paths are forbidden.
