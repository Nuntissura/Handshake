...
body_sha256: "86938add6ce0b87855aea2bd9efced54e52a574f1b0ae7fdb8f497798bdfd7b7"
...
One surface serves two audiences. Operators work through the GUI; models work through the backend knowledge/Loom/retrieval/navigation APIs over the same PostgreSQL/EventLedger authority records. Both audiences MUST observe the same canonical state; the unified surface introduces no parallel store and no markdown-vault authority.

#### 7.1.1.10 WP-KERNEL-009 Rich Document Save-to-Format: HTML Primary Projection [ADD v02.193]

Authority is unchanged: the versioned RichDocument record in PostgreSQL/EventLedger (Section 2.3.13.11) is the only authority for rich documents. An export file is never authority.
