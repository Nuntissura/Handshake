...
- Cloud model lanes MUST launch through the CloudLane/BYOK boundary and MUST carry the applicable ProjectionPlan and ConsentReceipt when workspace data leaves the local boundary.
