...
body_sha256: "880422a79e332bbd225acad8f523305a28ad43ba1c400538fc7472c83eacb9ae"
...
|---------|------|--------|---------|----------|
| v02.205 | 2026-08-15 | Kernel Builder | Closed the remaining active-spec contradictions after the v02.204 pivot. Handshake-managed SurrealDB is the exclusive durable product authority; EventLedger persistence, replay, privacy, live updates, schema rollout, and recovery are SurrealDB-native. PostgreSQL is completely retired: Handshake never connects to it, reads it, imports from it, reconciles it, falls back to it, or uses it as completion proof. SQLite is not an authority, cache, fallback, fixture, or proof path. SurrealDB initializes from an empty authority state because the current PostgreSQL database contains no valuable live information. [REFINE v02.205] | Operator-directed exclusive SurrealDB correction, 2026-08-15 |
| v02.204 | 2026-08-15 | Kernel Builder | Replaced PostgreSQL as Handshake's runtime authority with Handshake-managed SurrealDB across the product contract. EventLedger semantics remain authoritative; their persistence, privacy, live-update, schema-rollout, replay, and proof paths are now SurrealDB-native. PostgreSQL is limited to a bounded one-way legacy-import source and is never a fallback, parallel authority, or completion proof. [ADD v02.204] | Operator-directed SurrealDB pivot and approved `SURREALDB_SPEC_PIVOT_V02.204` proposal, 2026-08-15 |
...
## v02.202 Account-Bound Resource Privacy Enrichment [ADD v02.202]

Operator approval: `ilja260720260635`.

This release establishes account-bound resource identity and privacy as a permanent Handshake pillar. It records LocalAccount login and session authority, Principal attribution, AccountRole and MembershipRole separation, AccessSpace filtering, ResourceGrant authorization, Persona preference isolation, database-enforced record and field permissions, brokered filesystem/artifact access, same-project private resources, derived-scope non-widening, revocation, and future shared-workspace/SaaS/MCP continuity. The original v02.202 PostgreSQL implementation choice is superseded by the SurrealDB authority law in v02.204; the privacy semantics remain unchanged.

Canonical architecture lives in Section 2.3.13.12. Sections 1, 3, 4, 5, 7, 7.6, 8, 10, 11, and 12 project the same requirements into product principles, infrastructure, model roles, security/observability, user experience, roadmap, gap status/glossary, product surfaces, integration seams, and registries.
