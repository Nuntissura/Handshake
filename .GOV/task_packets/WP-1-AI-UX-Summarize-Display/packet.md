<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-AI-UX-Summarize-Display/packet.json source_hash=e7c84d8b1a07661c projection_hash=2639e827f391a54a generated_at_utc=2026-05-14T21:13:39.386Z generator=wp-contract-import.mjs -->
...
- **TEST_PLAN**:
  ...
  pnpm -C app run lint
  pnpm -C app test
  node .GOV/scripts/validation/post-work-check.mjs WP-1-AI-UX-Summarize-Display
  ```
- **DONE_MEANS**:
...
Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-AI-UX-Summarize-Display.md (status: In Progress)
...
Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-AI-UX-Summarize-Display.md (status: Ready for Dev)
- Spec: (not provided)
