<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Debug-Bundle/packet.json source_hash=5e77146d711d1405 projection_hash=080b248d74d24fce generated_at_utc=2026-05-06T15:57:13.008Z generator=wp-contract-import.mjs -->
...
Procedure:
1. Validator must check for debug bundle generation aligned to Roadmap A7.6.3.5.
2. Verify implementation matches the Main Body section governing Debug Bundles. Every line must be implemented.
3. If 100% alignment exists -> PASS. Otherwise -> FAIL.

---

## SCOPE
- What: Implement redacted reproducible debug bundles.
- Why: Provide reproducible troubleshooting artifacts.
- SPEC_ANCHOR: Debug bundle section (per Master Spec Main Body).
...
just validator-scan WP-1-Debug-Bundle
...
Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-Debug-Bundle.md (status: Ready for Dev)
- Spec: - SPEC_ANCHOR: Debug bundle section (per Master Spec Main Body).
