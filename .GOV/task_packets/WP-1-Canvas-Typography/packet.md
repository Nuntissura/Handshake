<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Canvas-Typography/packet.json source_hash=cc9b84b63d6f624f projection_hash=cd40dc5fd5e195aa generated_at_utc=2026-05-14T21:13:39.461Z generator=wp-contract-import.mjs -->
# Task Packet: WP-1-Canvas-Typography

## Metadata
- TASK_ID: WP-1-Canvas-Typography
- ROLE: Orchestrator
...
**Procedure:** 
1. Validator must search for `FontRegistry` and offline font loading logic.
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§7.6.3.16).
...
## SCOPE
- **What**: Implement backend-owned Font Registry and offline Design Pack loading.
- **Why**: Ensure professional typography and licensing compliance in the Canvas editor.
- **SPEC_ANCHOR**: Â§7.6.3.16
...
just validator-scan WP-1-Canvas-Typography
...
## VALIDATION REPORT — WP-1-Canvas-Typography
Verdict: FAIL

Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-Canvas-Typography.md (status: Ready for Dev)
- Spec: - **SPEC_ANCHOR**: Â§7.6.3.16
