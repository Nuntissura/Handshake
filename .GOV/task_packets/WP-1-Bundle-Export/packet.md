<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Bundle-Export/packet.json source_hash=2fa651d30a99e239 projection_hash=aafc96343610b4c4 generated_at_utc=2026-05-06T16:33:39.023Z generator=wp-contract-import.mjs -->
# Task Packet: WP-1-Bundle-Export

## Metadata
- TASK_ID: WP-1-Bundle-Export
- ROLE: Orchestrator
...
**Procedure:** 
1. Validator must search for `DebugBundle` and `WorkspaceBundle` logic.
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§7.6.3.15 / Â§11.5).
...
## SCOPE
- **What**: Implement Debug Bundle (redacted repro packets) and Workspace Bundle export (backup/transfer).
- **Why**: Allow users to export workspace state and provide developers with auditable bug reports.
- **SPEC_ANCHOR**: Â§7.6.3.15, Â§7.6.3.Acceptance
...
just validator-scan WP-1-Bundle-Export
