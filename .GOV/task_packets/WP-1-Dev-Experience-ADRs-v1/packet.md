<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Dev-Experience-ADRs-v1/packet.json source_hash=41552849a67788ef projection_hash=13a332a092dbb722 generated_at_utc=2026-05-14T21:13:39.495Z generator=wp-contract-import.mjs -->
...
- REFINEMENT_FILE: .GOV/refinements/WP-1-Dev-Experience-ADRs-v1.md
...
- IN_SCOPE_PATHS:
  ...
  - justfile
  - .GOV/adr/ADR-0002-runtime-selection-ollama.md
  - .GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md
  - .GOV/adr/ADR-0004-capability-model-shape.md
- OUT_OF_SCOPE:
...
### DONE_MEANS
- `.GOV/roles_shared/START_HERE.md` contains explicit Phase 1 setup steps for Ollama on Windows (install, run, verify) and removes any Phase 1-critical TBDs for local model runtime.
...
- ADRs exist under `.GOV/adr/` for: runtime selection (Ollama), DB layout for jobs+Flight Recorder, and capability model shape.
...
- Prior packet artifacts:
  - .GOV/task_packets/stubs/WP-1-Dev-Experience-ADRs.md (stub; not executable)
...
## IMPLEMENTATION
- Updated `.GOV/roles_shared/START_HERE.md` to replace Phase 1 runtime TBD with concrete Ollama install/run/verify steps and env overrides.
...
- **Timestamp**:
- **Operator**:
- **Spec Target Resolved**: .GOV/roles_shared/SPEC_CURRENT.md -> Handshake_Master_Spec_v02.115.md
...
- What changed in this update:
  - `.GOV/roles_shared/START_HERE.md` - Phase 1 Ollama setup steps + env overrides (replaces HSK-1001 TBD)
  - `justfile` - add `preflight-ollama` and run it before `dev`
  - `.GOV/adr/ADR-0002-runtime-selection-ollama.md` (new)
  - `.GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md` (new)
  - `.GOV/adr/ADR-0004-capability-model-shape.md` (new)
...
Scope Inputs:
- Task Packet: `.GOV/task_packets/WP-1-Dev-Experience-ADRs-v1.md` (status: In Progress)
- Spec: `.GOV/roles_shared/SPEC_CURRENT.md` -> `Handshake_Master_Spec_v02.115.md` (anchors per packet: 4.2.2.2; 2.6.6.6.3)

Files Checked:
- `.GOV/task_packets/WP-1-Dev-Experience-ADRs-v1.md`
- `.GOV/roles_shared/START_HERE.md`
- `justfile`
- `.GOV/adr/ADR-0002-runtime-selection-ollama.md`
- `.GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md`
...
Findings:
- PASS (Docs): `.GOV/roles_shared/START_HERE.md:95` documents Phase 1 Ollama setup; env overrides at `.GOV/roles_shared/START_HERE.md:104-105`.
- PASS (ADRs): ADRs exist at `.GOV/adr/ADR-0002-runtime-selection-ollama.md:1`, `.GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md:1`, `.GOV/adr/ADR-0004-capability-model-shape.md:1`.
...
Files Checked:
- `.GOV/task_packets/WP-1-Dev-Experience-ADRs-v1.md`
- `.GOV/refinements/WP-1-Dev-Experience-ADRs-v1.md`
- `.GOV/roles_shared/START_HERE.md`
- `justfile`
- `.GOV/adr/ADR-0002-runtime-selection-ollama.md`
- `.GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md`
...
Findings:
- PASS (Docs prerequisite): `.GOV/roles_shared/START_HERE.md:95` provides explicit Windows Ollama install/run/verify steps; env overrides documented at `.GOV/roles_shared/START_HERE.md:104`.
...
- PASS (ADRs): `.GOV/adr/ADR-0002-runtime-selection-ollama.md:1`, `.GOV/adr/ADR-0003-db-layout-jobs-and-flight-recorder.md:1`, `.GOV/adr/ADR-0004-capability-model-shape.md:1`.
- PASS (No model weights committed): `git ls-files | rg "\\.(gguf|safetensors|pt|pth)$"` returned no matches during validation.
- Forbidden Pattern Audit (in-scope): grep for `unwrap/expect/todo/panic/serde_json::Value/placeholder` showed only doc text describing directory placeholders (`.GOV/roles_shared/START_HERE.md:53-54`); no production-path placeholder/stub patterns introduced by this WP.
