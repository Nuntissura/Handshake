<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-LLM-Core-v3/packet.json source_hash=727b22c3c0a4fa26 projection_hash=87ce47368d50b7ed generated_at_utc=2026-05-14T21:13:39.582Z generator=wp-contract-import.mjs -->
...
- REFINEMENT_FILE: .GOV/refinements/WP-1-LLM-Core-v3.md
...
- OUT_OF_SCOPE:
  - Any Master Spec edits/version bumps (spec is already enriched; see .GOV/refinements/WP-1-LLM-Core-v3.md).
...
- WAIVER-20260104-LLMCORE-01: Spec enrichment already completed; do not create a new spec version for this WP. Keep spec authority as .GOV/roles_shared/SPEC_CURRENT.md in this worktree only. Approved by ilja on 2026-01-04.
