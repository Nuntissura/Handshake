<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-MEX-Safety-Gates/packet.json source_hash=d4fd2faef2cb1c30 projection_hash=acfa720dde9de0f9 generated_at_utc=2026-05-06T15:57:13.203Z generator=wp-contract-import.mjs -->
...
2. Verify implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§11.8 Mechanical Extension / Â§6.3.0 Envelopes).
3. Surface-level compliance with roadmap bullets (Â§7.6.3.10) is insufficient. Every line of text in the Main Body section must be implemented.
...
Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-MEX-Safety-Gates.md (status: Ready for Dev)
