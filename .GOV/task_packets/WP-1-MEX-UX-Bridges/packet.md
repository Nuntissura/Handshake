<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-MEX-UX-Bridges/packet.json source_hash=e23fa7e4f27bba7b projection_hash=69e6072d16ed81e0 generated_at_utc=2026-05-14T21:13:39.629Z generator=wp-contract-import.mjs -->
# Task Packet: WP-1-MEX-UX-Bridges

## Metadata
- TASK_ID: WP-1-MEX-UX-Bridges
- ROLE: Orchestrator
...
**Procedure:** 
1. Validator must check for `Clipboard` and `Notifier` job actions.
...
## SCOPE
- **What**: Implement capability-gated UX bridges (Clipboard, Notifier).
- **Why**: Allow AI to interact with the host OS UX while maintaining strict user consent.
...
just validator-scan WP-1-MEX-UX-Bridges
...
## VALIDATION REPORT — WP-1-MEX-UX-Bridges
Verdict: FAIL

Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-MEX-UX-Bridges.md (status: Ready for Dev)
