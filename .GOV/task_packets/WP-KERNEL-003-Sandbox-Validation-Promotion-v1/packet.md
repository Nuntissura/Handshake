<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-KERNEL-003-Sandbox-Validation-Promotion-v1/packet.json source_hash=10bcf9de618be432 projection_hash=ba4e3f3699dedca3 generated_at_utc=2026-05-17T17:03:37.245Z generator=ensure-wp-communications.mjs -->
...
- CURRENT_MAIN_COMPATIBILITY_BASELINE_SHA: 5b02198b1522a04d40f1ad5cc85dd69fde3034f0
<!-- Full local `main` HEAD sha inspected by the Integration Validator when current-main compatibility is checked. -->
- CURRENT_MAIN_COMPATIBILITY_VERIFIED_AT_UTC: 2026-05-17T15:45:00Z
...
Verdict: PASS
Blockers: NONE.
Next: Packet is contained in local `main` at `a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f` and Validated (PASS); see the appended Integration Validator V4 closeout report in `## VALIDATION_REPORTS` for dual-track evidence.
## CLAUSE_CLOSURE_MATRIX (AUTHORITATIVE SNAPSHOT; MUTABLE)
- Rule: this is the live packet-scope monitor for diff-scoped spec closure. Update statuses honestly; do not silently broaden or narrow clause scope after signature. Each row should point to TESTS, EXAMPLES, or governed debt.
- CLAUSE_ROWS:
  - CLAUSE: MT-001 Activation Source Inventory: re-scan stubs, Task Board, Build Order, and traceability for every KB003-related source. Acceptance: packet contains a source fold table at least as detailed as the stub. | CODE_SURFACES: .GOV/task_packets/**, .GOV/roles_shared/records/** | TESTS: just gov-check | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  - CLAUSE: MT-002 Conflict Deliberation Record: convert conflict register into signed decisions for raw shell, direct mutation, container-only, SQLite, and domain-evidence bloat. Acceptance: conflicts are approved, rejected, or parked, none silently removed. | CODE_SURFACES: .GOV/refinements/**, .GOV/task_packets/** | TESTS: just gov-check | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  - CLAUSE: MT-003 Current Product API Inventory: inspect product modules for KB001/KB002 and existing check/artifact/governance APIs. Acceptance: packet targets real files or declares missing upstream blockers. | CODE_SURFACES: src/backend/handshake_core/src/**, src/backend/handshake_core/tests/** | TESTS: rg EventLedger src/backend/handshake_core; rg WriteBox src/backend/handshake_core | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  - CLAUSE: MT-004 Research Basis Update: compare current sandbox adapter and validation evidence options before implementation. Acceptance: selected adapter sequence and rejected options are documented. | CODE_SURFACES: src/backend/handshake_core/src/kernel/**, README.md | TESTS: cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  - CLAUSE: MT-005 Official Packet Contract Generation: promote stub into signed official packet with contracts and 80 MTs. Acceptance: packet is ready but not self-validated by Kernel Builder. | CODE_SURFACES: .GOV/task_packets/WP-KERNEL-003-Sandbox-Validation-Promotion-v1/** | TESTS: just gov-check | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  ...
  - CLAUSE: MT-047 Finding Normalization: normalize check output into findings. Acceptance: raw logs are not the only finding source. | CODE_SURFACES: src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** | TESTS: cargo test -p handshake_core kernel_finding_normalization --target-dir ../Handshake_Artifacts/handshake-cargo-target | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
  ...
  - CLAUSE: MT-079 Documentation and Model Manual Update: update product-local model-facing manual. Acceptance: no-context model can run/inspect sandbox workflow from durable docs. | CODE_SURFACES: README.md, src/backend/handshake_core/src/kernel/**, app/** | TESTS: just gov-check | EXAMPLES: NONE | DEBT_IDS: NONE | CODER_STATUS: PROVED | VALIDATOR_STATUS: CONFIRMED
...
### 2026-05-17T15:45:00Z | INTEGRATION_VALIDATOR | session=INTEGRATION_VALIDATOR-20260517-1545Z
...
CLAUSES_REVIEWED:
  - MT-001 Activation Source Inventory: re-scan stubs, Task Board, Build Order, and traceability for every KB003-related source. Acceptance: packet contains a source fold table at least as detailed as the stub. => .GOV/task_packets/**, .GOV/roles_shared/records/** ; tests: just gov-check
  - MT-002 Conflict Deliberation Record: convert conflict register into signed decisions for raw shell, direct mutation, container-only, SQLite, and domain-evidence bloat. Acceptance: conflicts are approved, rejected, or parked, none silently removed. => .GOV/refinements/**, .GOV/task_packets/** ; tests: just gov-check
  - MT-003 Current Product API Inventory: inspect product modules for KB001/KB002 and existing check/artifact/governance APIs. Acceptance: packet targets real files or declares missing upstream blockers. => src/backend/handshake_core/src/**, src/backend/handshake_core/tests/** ; tests: rg EventLedger src/backend/handshake_core; rg WriteBox src/backend/handshake_core
  - MT-004 Research Basis Update: compare current sandbox adapter and validation evidence options before implementation. Acceptance: selected adapter sequence and rejected options are documented. => src/backend/handshake_core/src/kernel/**, README.md ; tests: cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-005 Official Packet Contract Generation: promote stub into signed official packet with contracts and 80 MTs. Acceptance: packet is ready but not self-validated by Kernel Builder. => .GOV/task_packets/WP-KERNEL-003-Sandbox-Validation-Promotion-v1/** ; tests: just gov-check
  - MT-006 Product Module Placement Decision: decide where sandbox, validation, and promotion modules live. Acceptance: module topology is documented before scaffolding. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/src/storage/** ; tests: cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-007 Kernel003 Schema Namespace: define stable schema IDs for KernelSandboxRunV1, SandboxPolicyV1, SandboxWorkspaceV1, SandboxArtifactBundleV1, ValidationRunV1, PromotionDecisionV1, and PromotionReceiptV1. Acceptance: schema names are versioned and referenced by EventLedger events. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-008 EventLedger Event Type Plan: add Kernel003 event type names and payload expectations. Acceptance: every event carries run ID, actor, session, task, schema version, timestamp, and artifact refs. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_event_ledger --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-009 Artifact Type Plan: define sandbox and validation artifact classes for logs, diffs, manifests, screenshots, reports, redaction, and receipts. Acceptance: each artifact class has content type, hash policy, exportability default, and retention/default root. => src/backend/handshake_core/src/governance_artifact_registry.rs, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_artifact --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-010 DCC Projection Contract: define minimum operator projection for sandbox and promotion state. Acceptance: no-context model can inspect state without terminal logs. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_dcc --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-011 Postgres Migration for Sandbox Runs: add authority tables for sandbox runs. Acceptance: records persist and replay after backend restart. => src/backend/handshake_core/src/storage/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_storage --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-012 Postgres Migration for Sandbox Policies: persist versioned sandbox policies. Acceptance: policy changes are versioned and traceable. => src/backend/handshake_core/src/storage/**, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_policy --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-013 Postgres Migration for Validation Runs: persist validation run metadata and summaries. Acceptance: validation results reconstruct without file-system-only state. => src/backend/handshake_core/src/storage/**, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_storage --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-014 Postgres Migration for Promotion Receipts: persist decisions and receipts. Acceptance: duplicate idempotency keys are rejected or idempotently resolved. => src/backend/handshake_core/src/storage/**, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_storage --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-015 No SQLite Authority Tripwire: prevent Kernel003 authority from using SQLite in production or tests. Acceptance: Kernel003 authority fails closed without Postgres/EventLedger authority. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_no_sqlite --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-016 Replay Projection Storage Query: reconstruct a run from durable rows/events. Acceptance: replay does not read provider chat, terminal scrollback, or transient logs. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/src/storage/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_replay --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-017 Legacy Compatibility Blocker Check: detect prerequisite API gaps. Acceptance: missing APIs produce BLOCKED with evidence, not parallel implementations. => src/backend/handshake_core/src/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_compat --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-018 SandboxAdapter Trait: define adapter boundary independent of Docker, WSL, Deno, or WASM. Acceptance: at least one adapter can be implemented without changing caller code. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_adapter --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-019 PolicyScopedLocal Adapter: implement minimum local proof adapter with strict policy checks. Acceptance: policy mode is explicitly not hard isolation and denies sensitive capabilities by default. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_policy_local --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-020 HardIsolation Adapter Stub: add non-executing adapter slot for hard isolation. Acceptance: hard isolation absence is typed BLOCKED/UNSUPPORTED, not success. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_hard_isolation --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-021 SandboxPolicy Default Deny: implement default-deny policy construction. Acceptance: omitted policy fields deny access. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_policy --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-022 Filesystem Scope Guard: enforce read/write roots and prevent path escape. Acceptance: all path escape attempts return typed denial evidence. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_fs_guard --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-023 Network Capability Gate: deny network unless policy grants it. Acceptance: network grants require approval/provenance refs. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_network --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-024 Process Execution Allowlist: permit only registered commands/checks. Acceptance: raw shell strings without descriptors are rejected. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_command_descriptor --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-025 Environment and Secret Redaction: prevent env/secret leakage. Acceptance: secret-looking values are not emitted in stored logs or reports. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_redaction --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-026 Resource Cap Policy: fold MTE resource caps into sandbox policy. Acceptance: overage halts or gates deterministically with evidence. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_resource_caps --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-027 Cancellation and Timeout: add cancellation and timeout handling. Acceptance: cancelled runs cannot promote and have typed terminal state. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_timeout --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-028 Sandbox Workspace Materializer: materialize candidate inputs into isolated root. Acceptance: no undeclared project files appear in sandbox input manifest. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_workspace --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-029 Sandbox Cleanup and Retention: clean temp roots while preserving artifacts. Acceptance: cleanup never deletes project files or authority rows. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_cleanup --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-030 Sandbox Adapter Health Projection: expose adapter health/preflight state. Acceptance: unsupported isolation is visible before run. => src/backend/handshake_core/src/kernel/**, app/**, tests/** ; tests: cargo test -p handshake_core kernel_sandbox_health --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-031 PatchProposal Contract: define candidate patch envelope. Acceptance: proposals without base refs or target ranges cannot enter validation. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_patch_proposal --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-032 Candidate Range Truth: validate changed paths/ranges against declared targets. Acceptance: unexpected file edits are rejected before promotion. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_candidate_range --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-033 Diff Capture: capture candidate diffs as stable artifacts. Acceptance: identical candidate produces identical diff artifact hash. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_diff_capture --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-034 Artifact Bundle Manifest: create canonical bundle format. Acceptance: bundle hash is deterministic for same inputs. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/src/governance_artifact_registry.rs, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_artifact_bundle --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-035 Stdout/Stderr Log Capture: store bounded command logs. Acceptance: logs never live only in terminal output. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_log_capture --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-036 Environment Manifest: record non-sensitive runtime environment identifiers. Acceptance: manifest explains run context without exposing secrets. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_environment_manifest --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-037 Command Manifest: record exactly what commands/checks ran. Acceptance: validators can replay or reason about command intent. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_command_manifest --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-038 Visual Evidence Attachment: attach KB002 screenshot/visual artifacts to validation reports. Acceptance: GUI reports can reference screenshots and DOM/log evidence. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_visual_evidence --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-039 Redaction Report: add redaction report to exportable bundles. Acceptance: default export is redacted and denied artifacts are listed. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_redaction_report --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-040 Artifact Store Integration: store sandbox artifacts through validated artifact system. Acceptance: every artifact has stable handle and hash. => src/backend/handshake_core/src/governance_artifact_registry.rs, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_artifact_store --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-041 ValidationDescriptor Contract: define validation command/check descriptors. Acceptance: validation runner rejects undeclared raw commands. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_descriptor --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-042 Check Runner Adapter: reuse Product Governance Check Runner. Acceptance: no duplicate check runner is created. => src/backend/handshake_core/src/governance_check_runner.rs, src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_check_runner_adapter --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-043 Validation Result Schema: define result states and finding shapes. Acceptance: every non-PASS has typed reason and evidence refs. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_result --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-044 Validation Preflight: preflight descriptors, tools, capabilities, policy mode, paths, and budget. Acceptance: missing tools produce BLOCKED/UNSUPPORTED, not silent skip. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_preflight --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-045 Deterministic Check Batch: run deterministic validation before model review. Acceptance: blocking check failure prevents promotion. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_batch --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-046 Validation Evidence Bundle: store validation outputs canonically. Acceptance: validation report can be inspected offline. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_bundle --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-047 Finding Normalization: normalize check output into findings. Acceptance: raw logs are not the only finding source. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_finding_normalization --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-048 Advisory vs Blocking Rules: make blocking posture explicit. Acceptance: advisory failure is visible but does not block unless configured. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_posture --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-049 Validation Replay: re-run descriptor set against same candidate. Acceptance: replay records new run ID linked to original. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_validation_replay --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-050 Validation Report Projection: expose validation summaries to DCC/projection layer. Acceptance: operator/model can inspect validation without reading raw files first. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_validation_projection --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-051 PromotionCandidate Contract: define promotion candidate shape from patch proposal or write box. Acceptance: missing validation refs block promotion. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_candidate --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-052 Promotion Eligibility Check: implement promotion preconditions. Acceptance: ineligible candidate produces typed rejection receipt. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_eligibility --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-053 Promotion Accept Path: append accepted promotion events to EventLedger. Acceptance: accepted promotion is replayable from durable events. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_accept --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-054 Promotion Reject Path: record rejected promotion attempts. Acceptance: reject path creates receipt and does not mutate authority. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_reject --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-055 Idempotency Key Enforcement: prevent duplicate promotion effects. Acceptance: duplicate accept returns prior receipt or typed duplicate rejection without second mutation. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/src/storage/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_idempotency --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-056 Approval Ref Binding: bind approval evidence to promotion decisions. Acceptance: promotion cannot accept without required approval posture. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_promotion_approval --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-057 Authority Mutation Boundary: sandbox and validation cannot mutate authority except through PromotionGate. Acceptance: direct mutation attempt produces denial evidence. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_authority_boundary --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-058 Promotion Closeout Bundle: implement canonical closeout bundle. Acceptance: Integration Validator can review one bundle for promotion. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_closeout_bundle --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-059 MTE Run Cap Integration: wire resource caps into sandboxed microtask execution. Acceptance: cap overage halts bounded run and writes evidence. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_mte_caps --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-060 Blocked Reason Taxonomy: implement blocked decisioning for sandbox/validation. Acceptance: each blocked reason has retry/escalate/gate semantics. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_blocked_taxonomy --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-061 Retry Budget: bound retry behavior. Acceptance: retry exhaustion becomes typed BLOCKED/FAILED. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_retry_budget --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-062 Smart DropBack: implement smart drop-back semantics. Acceptance: smart/always/never modes have test coverage. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_dropback --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-063 Per-MT Summary Artifact: persist per-microtask summaries. Acceptance: every completed/blocked MT attempt has summary ref. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_mt_summary --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-064 Aggregate Run Summary: persist aggregate summary across attempts. Acceptance: no-context reviewer can inspect aggregate before raw artifacts. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_aggregate_summary --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-065 Lane Wake Receipt: implement receipt-driven lane wake/settlement. Acceptance: wake/settlement event includes receipt refs and reason. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_lane_wake --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-066 Bootstrap Skeleton Receipt Projection: first skeleton sandbox run creates restartable receipts. Acceptance: all receipts visible after restart. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_sandbox_skeleton --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-067 DCC Sandbox Run List: add projection/API for sandbox run list. Acceptance: operator can find current and past sandbox runs. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_dcc_sandbox_list --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-068 DCC Run Detail: add projection/API for sandbox run detail. Acceptance: detail view has no hidden dependency on terminal scrollback. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_dcc_run_detail --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-069 DCC Promotion Control State: expose promotion eligibility and approval state. Acceptance: UI/API cannot promote when eligibility is false. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_dcc_promotion_state --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-070 Debug Bundle Bridge: fold diagnostics debug bundle into evidence output. Acceptance: diagnostics evidence is bounded and portable. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_debug_bundle --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-071 MCP/MEX Evidence Export Bridge: fold tool/mechanical engine evidence into sandbox evidence. Acceptance: MCP/MEX evidence does not use ad hoc bundle schema. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_mex_evidence --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-072 Capability Audit Evidence Link: link grants/denials to capability evidence. Acceptance: every sensitive grant has provenance. => src/backend/handshake_core/src/kernel/**, src/backend/handshake_core/tests/** ; tests: cargo test -p handshake_core kernel_capability_evidence --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-073 Visual Validation Gate Descriptor: define visual evidence validation mapping. Acceptance: visual evidence can block or advise according to descriptor posture. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_visual_descriptor --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-074 Console and Network Evidence: capture browser/app console and network evidence for GUI checks. Acceptance: GUI validation failures are diagnosable. => app/**, src/backend/handshake_core/src/kernel/**, tests/** ; tests: cargo test -p handshake_core kernel_gui_evidence --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-075 Security Denial Test Matrix: add negative tests for sandbox boundaries. Acceptance: every denial writes typed evidence. => src/backend/handshake_core/tests/**, src/backend/handshake_core/src/kernel/** ; tests: cargo test -p handshake_core kernel_security_denial --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-076 Promotion Failure Test Matrix: test each promotion failure scenario. Acceptance: no failure mutates authority. => src/backend/handshake_core/tests/**, src/backend/handshake_core/src/kernel/** ; tests: cargo test -p handshake_core kernel_promotion_failure --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-077 Restart Replay Test: prove state survives restart. Acceptance: replay is complete from durable product state. => src/backend/handshake_core/tests/**, src/backend/handshake_core/src/kernel/** ; tests: cargo test -p handshake_core kernel_restart_replay --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-078 Disk-Agnostic Path Test: prove paths remain repo-root/config relative. Acceptance: moving workspace root does not break path resolution. => src/backend/handshake_core/tests/**, src/backend/handshake_core/src/kernel/** ; tests: cargo test -p handshake_core kernel_disk_agnostic --target-dir ../Handshake_Artifacts/handshake-cargo-target
  - MT-079 Documentation and Model Manual Update: update product-local model-facing manual. Acceptance: no-context model can run/inspect sandbox workflow from durable docs. => README.md, src/backend/handshake_core/src/kernel/**, app/** ; tests: just gov-check
  - MT-080 Integration Validator Handoff: prepare final validation bundle without self-validating. Acceptance: Kernel Builder/Coder does not claim PASS/FAIL and validator has sufficient evidence. => .GOV/task_packets/WP-KERNEL-003-Sandbox-Validation-Promotion-v1/**, src/backend/handshake_core/tests/** ; tests: just gov-check; cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target
NOT_PROVEN:
  - NONE
...
DIFF_ATTACK_SURFACES:
  - `src/backend/handshake_core/src/kernel/kb003_promotion/**` owns the sole authority-writer path for KB003 sandboxed candidates; a regression here would let sandbox or validation paths mutate authority outside PromotionGate.
  - `src/backend/handshake_core/src/kernel/sandbox/**` enforces filesystem, network, exec, redaction, cap, and cancellation policy; a misconfiguration would let sandboxed runs escape policy boundaries before reaching promotion.
  - `src/backend/handshake_core/src/storage/kb003_storage.rs` and `src/backend/handshake_core/migrations/**` persist sandbox runs, policies, validation runs, and promotion decisions/receipts; a schema or migration gap would break replay and idempotency.
  - `src/backend/handshake_core/src/kernel/validation/**` reuses the existing `governance_check_runner::CheckRunner` via the `ValidationCheckRunner` adapter; a duplicate runner here would create a shadow authority outside the shared check surface.
  - `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs` fails closed on non-PostgresPrimary; a regression would silently allow SQLite kernel authority.
  - `app/src-tauri/Cargo.toml` carried a `uuid` feature merge conflict (`v4` vs `v7`); regressing the resolution to `v4` would re-introduce a banned dependency per HBR-INT-008.

INDEPENDENT_CHECKS_RUN:
  - `cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target` from `src/backend/handshake_core` against post-merge HEAD `a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f` => PASS; 1114 passed, 0 failed, 22 ignored (15 postgres-env-dependent, 7 duckdb-feature-gated). Recorded as TEST_VERDICT=PASS basis.
  - `git grep -nE 'Uuid::new_v4' src/backend src/frontend app/src-tauri/src` against post-merge HEAD => expected absence; zero product residuals of `Uuid::new_v4`. Recorded as HBR-INT-008 retention proof.
  - `git -C handshake_main merge-base --is-ancestor a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f HEAD` => is_ancestor=yes; main containment verified.
  - `git -C handshake_main show --stat a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f` and `git log --oneline a813b761^..a813b761` => single integration merge commit `merge: WP-KERNEL-003 sandbox validation promotion (IV PASS)`; KB001/KB002 product files untouched outside the `uuid v4 -> v7` sweep.
  - `cargo tree --features runtime-full -i uuid` => expected `uuid` only at `v7` feature set; `v4` feature is absent from the post-merge dependency tree.

COUNTERFACTUAL_CHECKS:
  - If `src/backend/handshake_core/src/kernel/kb003_promotion/gate.rs` stopped routing authority writes through `PromotionGate::insert_promotion_decision/receipt`, the `AuthorityBoundaryCheck` wiring in `Kb003Storage` would fail and sandbox/validation rows could mutate authority directly (H2 remediation regression).
  - If `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs` stopped failing closed on non-PostgresPrimary backends, the MT-015 + MT-077 tests would fail and KB003 authority could silently land on SQLite test storage.
  - If `src/backend/handshake_core/src/kernel/validation/check_runner_adapter.rs` instantiated a parallel runner instead of delegating to `governance_check_runner::CheckRunner`, the MT-042 reuse test would fail and KB003 would acquire a shadow check authority outside the shared surface.
  - If `app/src-tauri/Cargo.toml` regressed to the `v4` `uuid` feature, the `cargo deny`/clippy lint enforced under HBR-INT-008 would re-fire and CI would refuse the build.
  - If `src/backend/handshake_core/src/kernel/sandbox/exec_allowlist.rs` accepted raw shell strings without descriptors, MT-024's negative tests in `src/backend/handshake_core/tests/kernel_sandbox_command_descriptor_tests.rs` would fail and the sandbox would lose process-execution discipline.

BOUNDARY_PROBES:
  - Authority-writer boundary => `src/backend/handshake_core/src/kernel/kb003_promotion/gate.rs`, `src/backend/handshake_core/src/storage/kb003_storage.rs`, and `src/backend/handshake_core/src/kernel/authority_boundary.rs` were reviewed together so PromotionGate is the only path that writes promotion decisions and receipts and `AuthorityBoundaryCheck` is wired into both insert paths.
  - Storage boundary => `src/backend/handshake_core/src/storage/mod.rs`, `src/backend/handshake_core/src/storage/kb003_storage.rs`, and `src/backend/handshake_core/migrations/**` were reviewed as one boundary so the storage trait, KB003 impl, and Postgres migrations agree on sandbox/validation/promotion row shape and replay primitives.
  - Check-runner boundary => `src/backend/handshake_core/src/governance_check_runner.rs` (the shared surface) and `src/backend/handshake_core/src/kernel/validation/check_runner_adapter.rs` were reviewed together so the KB003 validation lane reuses the existing runner instead of forking it.
  - Event-emission boundary => `src/backend/handshake_core/src/kernel/kb003_promotion/event_emission.rs` and the existing `KernelActor`/EventLedger path were reviewed together so KB003 emits via the inherited authority path rather than creating a parallel ledger.

NEGATIVE_PATH_CHECKS:
  - `src/backend/handshake_core/tests/kernel_security_denial_tests.rs` (MT-075) exercises filesystem escape, undeclared exec, network without grant, env/secret leakage, and cap overage; every denial writes typed evidence rather than passing silently.
  - `src/backend/handshake_core/tests/kernel_promotion_failure_tests.rs` (MT-076) exercises stale candidate, duplicate idempotency key, validation failure, policy denial, missing approval, missing artifact, Postgres failure, and projection rebuild failure; no failure mutates authority.
  - `src/backend/handshake_core/tests/kernel_restart_replay_tests.rs` (MT-077) destroys and re-opens the kernel runtime, asserts that all sandbox/validation/promotion rows reconstruct from durable Postgres state with no SQLite fallback.
  - `src/backend/handshake_core/tests/kernel_disk_agnostic_tests.rs` (MT-078) re-roots the workspace and confirms KB003 path resolution remains repo-root/config relative.

INDEPENDENT_FINDINGS:
  - The adversarial code review surfaced and closed 22 items (5 HIGH blockers, 10 MEDIUM, 3 strongly-recommended, 4 LOW); the HIGH set included the PromotionGate-as-sole-authority refactor (H2), the no-SQLite tripwire fail-closed semantics, and the UUID v4 -> v7 sweep across product code.
  - Whole-WP Master Spec validation against all 6 declared anchors records 80/80 microtask acceptance criteria PASS with no remaining MUST clause unproven; the only PARTIAL items (10.11.5.28 GUI evidence rendering, 11 sandbox-minimum hardened-isolation) are explicitly carried as out-of-WP-scope per `refinement.non_goals`.
  - UUID migration is enforced at compile time per HBR-INT-008: the `v4` feature is removed from `app/src-tauri/Cargo.toml`, the post-merge dependency tree contains no `v4` feature on `uuid`, and clippy/cargo-deny enforce zero residuals going forward.

RESIDUAL_UNCERTAINTY:
  - 22 ignored test cases remain environment-gated: 15 require a live Postgres test URL (covered by the inherited KB001 live-Postgres proof path) and 7 require the `duckdb-flight-recorder` feature flag; both are deterministic environment gates, not silent skips, but they were not exercised in this closeout pass.
  - Adapter coverage is limited to PolicyScopedLocal in this WP; hardened-isolation execution and full container/WASM isolation are explicitly carried to WP-KERNEL-004 per `refinement.non_goals` and remain unproven inside KB003.
  - Two 10.11.5.28 GUI projection clauses are PARTIAL (front-end debug-bundle bridge, full GUI evidence rendering); they are wired at the backend projection layer but the matching front-end surfaces are deferred to WP-KERNEL-004 follow-ons.

SPEC_CLAUSE_MAP:
  - `.GOV/spec/master-spec-v02.185/spec-modules/02-system-architecture.md#2.3.13.9` Mechanical Sandbox Adapter Family => `src/backend/handshake_core/src/kernel/sandbox/adapter.rs`; `src/backend/handshake_core/src/kernel/sandbox/policy_scoped_local.rs`; `src/backend/handshake_core/src/kernel/sandbox/hard_isolation_stub.rs`; `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs`
  - `.GOV/spec/master-spec-v02.185/spec-modules/02-system-architecture.md#2.3.13.10` Sandbox Policy and Capability Gating => `src/backend/handshake_core/src/kernel/sandbox/policy.rs`; `src/backend/handshake_core/src/kernel/sandbox/fs_guard.rs`; `src/backend/handshake_core/src/kernel/sandbox/network_gate.rs`; `src/backend/handshake_core/src/kernel/sandbox/exec_allowlist.rs`; `src/backend/handshake_core/src/kernel/sandbox/redaction.rs`; `src/backend/handshake_core/src/kernel/sandbox/resource_caps.rs`; `src/backend/handshake_core/src/kernel/sandbox/cancellation.rs`
  - `.GOV/spec/master-spec-v02.185/spec-modules/05-security-and-observability.md#5.2.5` Mechanical Runner Sandbox => `src/backend/handshake_core/src/kernel/sandbox/exec_allowlist.rs`; `src/backend/handshake_core/src/kernel/sandbox/resource_caps.rs`; `src/backend/handshake_core/src/kernel/sandbox/redaction.rs`
  - `.GOV/spec/master-spec-v02.185/spec-modules/05-security-and-observability.md#5.4.5` Kernel V1 Authority Observability Boundary => `src/backend/handshake_core/src/kernel/kb003_promotion/gate.rs`; `src/backend/handshake_core/src/kernel/kb003_promotion/event_emission.rs`; `src/backend/handshake_core/src/storage/kb003_storage.rs`
  - `.GOV/spec/master-spec-v02.185/spec-modules/10-product-surfaces.md#10.11.5.28` Kernel Action Catalog and Write Box Projections => `src/backend/handshake_core/src/kernel/dcc_kb003_sandbox_list.rs`; `src/backend/handshake_core/src/kernel/dcc_kb003_run_detail.rs`; `src/backend/handshake_core/src/kernel/dcc_kb003_promotion_state.rs`; `src/backend/handshake_core/src/kernel/dcc_kb003_visual_evidence.rs`
  - `.GOV/spec/master-spec-v02.185/spec-modules/11-shared-dev-platform-and-oss-foundations.md#sandbox-minimum` Sandbox Minimum => `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs`; `src/backend/handshake_core/src/kernel/sandbox/policy_scoped_local.rs`

NEGATIVE_PROOF:
  - 2.3.13.10 Sandbox Policy and Capability Gating has 1/7 clauses NOT fully implemented: the hardened-isolation execution surface (full container/WASM enforcement) is explicitly NOT delivered by KB003 and is carried to `WP-KERNEL-004` per `refinement.non_goals`; only the policy-scoped local adapter at `src/backend/handshake_core/src/kernel/sandbox/policy_scoped_local.rs` and the non-executing stub at `src/backend/handshake_core/src/kernel/sandbox/hard_isolation_stub.rs` are present.
  - 10.11.5.28 Kernel Action Catalog and Write Box Projections has 2/9 clauses PARTIAL: the front-end debug-bundle bridge and full GUI evidence rendering paths land at the backend projection layer only (`src/backend/handshake_core/src/kernel/dcc_kb003_visual_evidence.rs`, `src/backend/handshake_core/src/kernel/dcc_kb003_run_detail.rs`); the matching `app/` front-end surfaces are deferred to WP-KERNEL-004 follow-ons and are NOT fully implemented by KB003.
  - 11 Sandbox Minimum has 1/3 clauses out-of-WP: full container/WASM isolation is explicitly NOT in scope for KB003; only `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs` and `src/backend/handshake_core/src/kernel/sandbox/policy_scoped_local.rs` are present, with no hardened-isolation adapter implementation under `src/backend/handshake_core/src/kernel/sandbox/`.
...
PRIMITIVE_RETENTION_PROOF:
  - EventLedger primitive => `src/backend/handshake_core/src/kernel/kb003_promotion/event_emission.rs` emits via the inherited `KernelActor`->EventLedger path with no parallel ledger; KB001 EventLedger schema and append APIs remain untouched in `src/backend/handshake_core/src/kernel/event_ledger.rs`.
  - ContextBundle / ModelAdapter / TraceProjection primitives => KB001 surfaces in `src/backend/handshake_core/src/kernel/context_bundle.rs`, `src/backend/handshake_core/src/llm/**`, and `src/backend/handshake_core/src/kernel/trace_projection.rs` remain unchanged; KB003 binds without modifying these contracts.
  - WriteBox / ToolGate / action_catalog primitives => KB002 surfaces in `src/backend/handshake_core/src/kernel/write_box.rs`, `src/backend/handshake_core/src/mcp/gate.rs`, and `src/backend/handshake_core/src/kernel/action_catalog.rs` remain unchanged; KB003 binds via `direct_edit_guard` and `write_boxes` without re-shaping the primitives.
  - PromotionGate primitive => `src/backend/handshake_core/src/kernel/kb003_promotion/gate.rs` is the sole authority writer per the H2 remediation; `AuthorityBoundaryCheck` is wired into `Kb003Storage::insert_promotion_decision` and `Kb003Storage::insert_promotion_receipt`, preserving the KB001 PromotionGate semantics on the new lane.
  - No-SQLite primitive => `src/backend/handshake_core/src/kernel/sandbox/no_sqlite_tripwire.rs` fails closed on non-PostgresPrimary backends; covered by MT-015 and MT-077 tests in `src/backend/handshake_core/tests/kernel_no_sqlite_tests.rs` and `src/backend/handshake_core/tests/kernel_restart_replay_tests.rs`.

PRIMITIVE_RETENTION_GAPS:
  - NONE

SHARED_SURFACE_INTERACTION_CHECKS:
  - `src/backend/handshake_core/src/governance_check_runner.rs` (the shared CheckRunner surface) is reused via `src/backend/handshake_core/src/kernel/validation/check_runner_adapter.rs` (the `ValidationCheckRunner` adapter from MT-042); no parallel runner is introduced and the shared surface signature is unchanged.
  - `src/backend/handshake_core/src/kernel/mod.rs` shared kernel surface received only `mod` declarations for the KB003 submodules; no behavioral changes were applied to KB001 or KB002 paths through this file.
  - `src/backend/handshake_core/src/storage/mod.rs` shared storage surface received only the `kb003_storage` module registration; the pre-existing storage trait, KB001 Postgres impl, and KB002 write-box storage paths remain unchanged.
  - `src/backend/handshake_core/src/governance_artifact_registry.rs`, `src/backend/handshake_core/src/flight_recorder/**`, and the `role_mailbox` shared surfaces were not touched by KB003 (verified by `git diff main..HEAD` over the merged commit).
  - KB001 `src/backend/handshake_core/src/kernel/session_broker.rs` and KB002 `src/backend/handshake_core/src/kernel/promotion.rs` were not modified by KB003 code paths; the only edits to those areas were the mechanical UUID v4 -> v7 sweep, which preserves their contracts.

CURRENT_MAIN_INTERACTION_CHECKS:
  - Pre-merge local `main` HEAD reviewed: `5b02198b1522a04d40f1ad5cc85dd69fde3034f0` (`gov: add root CLAUDE.md mirror of AGENTS.md per global mirror discipline`).
  - Merge produced exactly one conflict, in `app/src-tauri/Cargo.toml` on the `uuid` feature set (`v4` vs `v7`); resolved by taking `v7` per HBR-INT-008 compliance. No conflicts in KB001 or KB002 product code; the UUID sweep was mechanical and did not change any KB001/KB002 contract.
  - Post-merge `cargo test -p handshake_core --target-dir ../Handshake_Artifacts/handshake-cargo-target` against `a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f` => 1114 passed, 0 failed, 22 ignored; confirms current-main compatibility at the unit/integration test layer.
  - DCC and runtime governance contracts in `src/backend/handshake_core/src/runtime_governance.rs` and `src/backend/handshake_core/src/workflows.rs` are not modified by KB003 (KB003 adds new sandbox/validation/promotion lanes; it does not modify pre-existing lanes), so existing main-side callers compose with the merged tree unchanged.
  - `git merge-base --is-ancestor a813b7615f4e29d77ed8ee0b3ea8845ad5fd406f HEAD` against `handshake_main` HEAD returned true => main containment confirmed at the recorded SHA.

DATA_CONTRACT_PROOF:
  - `src/backend/handshake_core/src/kernel/kb003_schemas.rs` defines typed schema IDs and versioned payloads for KernelSandboxRunV1, SandboxPolicyV1, SandboxWorkspaceV1, SandboxArtifactBundleV1, ValidationRunV1, PromotionDecisionV1, and PromotionReceiptV1.
  - `src/backend/handshake_core/src/storage/kb003_storage.rs` and `src/backend/handshake_core/migrations/**` persist the schema rows with stable IDs and idempotency keys; replay is reconstructable from Postgres alone (MT-016 and MT-077 tests).
  - `src/backend/handshake_core/tests/kernel_validation_storage_tests.rs`, `src/backend/handshake_core/tests/kernel_promotion_storage_tests.rs`, and `src/backend/handshake_core/tests/kernel_restart_replay_tests.rs` exercise the data contract end to end against the durable storage primitives.
