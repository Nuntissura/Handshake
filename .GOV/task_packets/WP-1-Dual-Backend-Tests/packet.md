<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Dual-Backend-Tests/packet.json source_hash=1178979a231dfd85 projection_hash=fa845889db6df9b1 generated_at_utc=2026-05-14T21:13:39.519Z generator=wp-contract-import.mjs -->
...
- Task Packet: .GOV/task_packets/WP-1-Dual-Backend-Tests.md
...
Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-Dual-Backend-Tests.md (STATUS missing)
- Spec: Packet lacks a SPEC_CURRENT pointer/versioned anchor; .GOV/roles_shared/SPEC_CURRENT.md points to Handshake_Master_Spec_v02.93 (A2.3.12).
- Codex: Handshake Codex v1.4.md
