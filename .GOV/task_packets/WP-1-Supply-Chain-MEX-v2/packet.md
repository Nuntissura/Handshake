<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Supply-Chain-MEX-v2/packet.json source_hash=99e016054d45e7ae projection_hash=b5e8ac002f0d0243 generated_at_utc=2026-05-06T16:33:39.604Z generator=wp-contract-import.mjs -->
...
- REFINEMENT_FILE: .GOV/refinements/WP-1-Supply-Chain-MEX-v2.md
...
- OUT_OF_SCOPE:
  - Any Master Spec edits/version bumps (see `.GOV/refinements/WP-1-Supply-Chain-MEX-v2.md`).
  - Any changes in app/ or app/src-tauri/ or src/ outside the IN_SCOPE_PATHS above.
  - Any modifications to .GOV/scripts/ (CI checks, deterministic enforcement scripts) in this packet.
...
- Prior packets:
  - .GOV/task_packets/WP-1-Supply-Chain-MEX.md (historical FAIL; incomplete supply-chain gate implementation)
  - .GOV/task_packets/stubs/WP-1-Supply-Chain-MEX-v2.md (stub backlog; superseded by this official packet)
...
- FILES_TO_OPEN:
  ...
  - .GOV/refinements/WP-1-Supply-Chain-MEX-v2.md
...
- .GOV/roles/coder/CODER_PROTOCOL.md
- .GOV/refinements/WP-1-Supply-Chain-MEX-v2.md
- .GOV/task_packets/WP-1-Supply-Chain-MEX-v2.md
- .GOV/task_packets/WP-1-Supply-Chain-MEX.md
...
- Notes:
  - `.GOV/roles_shared/START_HERE.md` contains an outdated SPEC_CURRENT version string ("v02.111"); OUT_OF_SCOPE forbids updating it in this WP.
...
Scope Inputs:
- Task Packet: `.GOV/task_packets/WP-1-Supply-Chain-MEX-v2.md` (**Status:** Done)
...
- Active Packet mapping: `.GOV/roles_shared/WP_TRACEABILITY_REGISTRY.md:110`
