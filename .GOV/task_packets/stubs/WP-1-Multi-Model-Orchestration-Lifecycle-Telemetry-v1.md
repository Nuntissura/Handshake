...
- [ ] Create `.GOV/refinements/WP-1-Multi-Model-Orchestration-Lifecycle-Telemetry-v1.md` (approved/signed).
- [ ] Create the official task packet via `just create-task-packet WP-1-Multi-Model-Orchestration-Lifecycle-Telemetry-v1` (in `.GOV/task_packets/`).
