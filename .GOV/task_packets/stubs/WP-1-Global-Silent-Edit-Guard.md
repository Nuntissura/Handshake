...
- [ ] Create `.GOV/refinements/WP-1-Global-Silent-Edit-Guard.md` (approved/signed).
- [ ] Create official task packet via `just create-task-packet WP-1-Global-Silent-Edit-Guard` (in `.GOV/task_packets/`).
