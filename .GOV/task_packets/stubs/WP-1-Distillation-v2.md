# Task Packet Stub: WP-1-Distillation-v2
...
- / FAIL: Teacher metadata, Skill Bank schema. [READY FOR DEV]
...
2. USER_SIGNATURE.
3. Create `.GOV/refinements/WP-1-Distillation-v2.md`.
4. Create official task packet via `just create-task-packet WP-1-Distillation-v2`.
5. Update `.GOV/roles_shared/WP_TRACEABILITY_REGISTRY.md` to point `WP-1-Distillation` -> `WP-1-Distillation-v2`.
6. Update `.GOV/roles_shared/TASK_BOARD.md` to move `WP-1-Distillation-v2` out of STUB when activated.
