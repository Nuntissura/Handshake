...
- [ ] Create `.GOV/refinements/WP-1-Git-Engine-Decision-Gate-v1.md` (approved/signed).
- [ ] Create the official task packet via `just create-task-packet WP-1-Git-Engine-Decision-Gate-v1` (in `.GOV/task_packets/`).
