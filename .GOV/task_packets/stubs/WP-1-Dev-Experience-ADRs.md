...
- IN_SCOPE:
  ...
  - Add initial ADRs under `.GOV/adr/` for the required key choices.
- OUT_OF_SCOPE:
...
- [ ] Create `.GOV/refinements/WP-1-Dev-Experience-ADRs.md` (approved/signed).
- [ ] Create official task packet via `just create-task-packet WP-1-Dev-Experience-ADRs` (in `.GOV/task_packets/`).
