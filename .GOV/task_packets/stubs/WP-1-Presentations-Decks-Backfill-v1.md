...
# Work Packet Stub: WP-1-Presentations-Decks-Backfill-v1

## STUB_METADATA
- WP_ID: WP-1-Presentations-Decks-Backfill-v1
- BASE_WP_ID: WP-1-Presentations-Decks-Backfill
- CREATED_AT: 2026-03-08T05:54:32.875Z
- STUB_STATUS: STUB (NOT READY FOR DEV)
- BUILD_ORDER_DOMAIN: CROSS_BOUNDARY
- BUILD_ORDER_TECH_BLOCKER: NO
- BUILD_ORDER_VALUE_TIER: MEDIUM
- BUILD_ORDER_RISK_TIER: MEDIUM
- BUILD_ORDER_DEPENDS_ON: WP-1-Charts-Dashboards-Backfill, WP-1-Docs-Sheets-Runtime-Backfill
...
- SPEC_ANCHOR_CANDIDATES (Main Body, not Roadmap):
  ...
  - Handshake_Master_Spec_v02.144.md 2.5.11 Charts & Decks AI Job Profile

## INTENT (DRAFT)
- What: Backfill Decks as a governed composition/export surface with explicit slide sources, runtime identity, and operator evidence.
- Why: Decks are a natural force multiplier over Docs, Charts, and Project Brain, but current appendix coverage is too sparse.

## SCOPE_SKETCH (DRAFT)
- IN_SCOPE:
  - DeckSpec runtime coverage.
  - Source-linking from docs/charts.
- OUT_OF_SCOPE:
  - Final deck-authoring UX polish.
  - Broad presentation design system work.
...
- Decks have explicit runtime mapping and source-linking coverage.
- Appendix coverage makes deck generation deterministic for later model/tool use.

## DEPENDENCIES / BLOCKERS (DRAFT)
- Depends on source surfaces (Docs/Charts) carrying reliable provenance.

## RISKS / UNKNOWNs (DRAFT)
- Risk: deck output becomes detached from source evidence and impossible to reason over later.
...
- [ ] Create `.GOV/refinements/WP-1-Presentations-Decks-Backfill-v1.md` (approved/signed).
- [ ] Create the official task packet via `just create-task-packet WP-1-Presentations-Decks-Backfill-v1` (in `.GOV/task_packets/`).
