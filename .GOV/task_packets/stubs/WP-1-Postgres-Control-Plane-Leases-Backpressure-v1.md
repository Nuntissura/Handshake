...
- KERNEL_RESET_TRANSFER_SCOPE: Atomic claim, lease, heartbeat, reclaim, dead-letter, and backpressure semantics for Kernel V1 SessionBroker; use Kernel001 packet/refinement/MTs for activation.
