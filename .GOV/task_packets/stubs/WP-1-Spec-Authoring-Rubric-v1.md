...
- ROADMAP_POINTER: AÂ§7.6.3 (Phase 1) -> Spec Router + governance session log (MVP)
- SPEC_ANCHOR_CANDIDATES (Main Body, not Roadmap):
  - AÂ§2.6.8.11 Spec Authoring Rubric (Normative)
  - AÂ§11.1.5.1 Required Roles: Fixed Trinity (Normative)
...
- [ ] Create `.GOV/refinements/WP-1-Spec-Authoring-Rubric-v1.md` (approved/signed).
- [ ] Create the official task packet via `just create-task-packet WP-1-Spec-Authoring-Rubric-v1` (in `.GOV/task_packets/`).
