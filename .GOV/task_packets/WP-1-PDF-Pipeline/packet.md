<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-PDF-Pipeline/packet.json source_hash=98016b54b2bcd5f4 projection_hash=9972ff6a05ea28f2 generated_at_utc=2026-05-14T21:13:39.661Z generator=wp-contract-import.mjs -->
# Task Packet: WP-1-PDF-Pipeline

## Metadata
- TASK_ID: WP-1-PDF-Pipeline
- ROLE: Orchestrator
...
**Procedure:** 
1. Validator must search for Typst and qpdf integration in the backend.
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§7.6.3.14 / Â§11.10.1).
...
## SCOPE
- **What**: Implement `creative.deliverables.pdf_packaging` job path using Typst + qpdf.
- **Why**: Provide professional, byte-stable PDF export for creative deliverables.
- **SPEC_ANCHOR**: Â§7.6.3.14, Â§11.10.1
...
just validator-scan WP-1-PDF-Pipeline
...
## VALIDATION REPORT — WP-1-PDF-Pipeline
Verdict: FAIL

Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-PDF-Pipeline.md (status: Ready for Dev)
- Spec: - **SPEC_ANCHOR**: Â§7.6.3.14, Â§11.10.1
