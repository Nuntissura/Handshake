<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.microtask_contract@1 source_file=.GOV/task_packets/WP-1-Atelier-Lens-Consolidation-v1/MT-039.json source_hash=ce3da634e08a6fd8 projection_hash=4c1b3cce133e38c6 generated_at_utc=2026-05-16T03:39:00.000Z generator=.GOV/roles_shared/scripts/wp/atelier-lens-consolidation-packet-generator.mjs -->
...
- STATUS: PENDING
- DEPENDS_ON: MT-038
- CLAUSE: Build SQLite absolute rejection row and no-test/no-fixture tripwire
...
- RISK_IF_MISSED: SQLite could re-enter as a runtime, test, fixture, mock, fallback, cache, compatibility, import, export, or temporary harness assumption.
...
- Microtask source bucket: Build SQLite absolute rejection row and no-test/no-fixture tripwire
