<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.microtask_contract@1 source_file=.GOV/task_packets/WP-1-Atelier-Lens-Consolidation-v1/MT-005.json source_hash=cdfa4cffa67fd597 projection_hash=afef7bb13c314087 generated_at_utc=2026-05-16T03:39:00.000Z generator=.GOV/roles_shared/scripts/wp/atelier-lens-consolidation-packet-generator.mjs -->
...
- STATUS: COMPLETE
- DEPENDS_ON: NONE
- CLAUSE: Inventory CKC ComfyUI bridge files
- CATEGORY: Inventory
...
- RISK_IF_MISSED: Media pipeline behavior could lose provenance, schema, or replay evidence.
...
- Microtask source bucket: Inventory CKC ComfyUI bridge files
...
- COMPLETION_NOTE: ComfyUI bridge files inventoried from CKC source evidence.
- EVIDENCE_ARTIFACTS:
