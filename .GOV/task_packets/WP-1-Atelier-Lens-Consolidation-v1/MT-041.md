<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.microtask_contract@1 source_file=.GOV/task_packets/WP-1-Atelier-Lens-Consolidation-v1/MT-041.json source_hash=7d40813ca3e31c4f projection_hash=0b44795afcead4e5 generated_at_utc=2026-05-16T03:39:00.000Z generator=.GOV/roles_shared/scripts/wp/atelier-lens-consolidation-packet-generator.mjs -->
...
- STATUS: PENDING
- DEPENDS_ON: MT-040
- CLAUSE: Build localhost intake rejection and Handshake endpoint translation row
...
- RISK_IF_MISSED: CKC runtime authority could be copied into Handshake instead of translated to Handshake boundaries.
...
- Microtask source bucket: Build localhost intake rejection and Handshake endpoint translation row
