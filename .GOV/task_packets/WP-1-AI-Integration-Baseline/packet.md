<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-AI-Integration-Baseline/packet.json source_hash=83342a0a6a2ec81d projection_hash=1414b08116207f69 generated_at_utc=2026-05-06T15:57:12.828Z generator=wp-contract-import.mjs -->
...
2. Verify implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§4.0 Model Runtime Layer).
3. Surface-level compliance with roadmap bullets (Â§7.6.3.1) is insufficient. Every line of text in the Main Body section must be implemented (Typed errors, budgeting, context assembly).
...
- **TEST_PLAN**:
  ...
  pnpm -C app test
  node .GOV/scripts/validation/post-work-check.mjs WP-1-AI-Integration-Baseline
  ```
- **DONE_MEANS**:
...
## VALIDATION REPORT â€” WP-1-AI-Integration-Baseline
Verdict: FAIL

Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-AI-Integration-Baseline.md (status: In Progress)
...
- **Flight Recorder Integration**: `DONE_MEANS` mentions logging but lacks specific event shapes defined in Â§11.5 of v02.84.

Risks & Suggested Actions:
- **RE-OPEN** for Spec Alignment. Orchestrator must update packet to reference v02.84 and include technical constraints from Â§4.1-4.3.
