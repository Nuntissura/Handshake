<!-- HANDSHAKE_GENERATED_PROJECTION schema_id=hsk.work_packet_contract@1 source_file=.GOV/task_packets/WP-1-Atelier-Lens/packet.json source_hash=3c36bbfca761906f projection_hash=e1a84f9e37253a0c generated_at_utc=2026-05-14T21:13:39.397Z generator=wp-contract-import.mjs -->
# Task Packet: WP-1-Atelier-Lens

## Metadata
- TASK_ID: WP-1-Atelier-Lens
- ROLE: Orchestrator
...
**Procedure:** 
1. Validator must check implementation of `ATELIER_CLAIM` mechanical job.
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (Â§2.6.6.7.14 / Â§7.6.3.19).
...
## SCOPE
- **What**: Implement the Atelier Lens v0.1 runtime and role extraction logic.
- **Why**: Allow AI to claim creative roles and extract structured intent with deterministic merge rules.
...
just validator-scan WP-1-Atelier-Lens
...
## VALIDATION REPORT — WP-1-Atelier-Lens
Verdict: FAIL

Scope Inputs:
- Task Packet: .GOV/task_packets/WP-1-Atelier-Lens.md (status: Ready for Dev)
- Spec: - **SPEC_ANCHOR**: Â§7.6.3.19, Â§2.6.6.7.14
