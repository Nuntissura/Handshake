...
- `just wp-relay-watchdog [WP-{ID}] [--loop] [--interval-seconds N] [--no-watch-steer]` — non-LLM relay watcher and safe re-wake helper for orchestrator-managed lanes
