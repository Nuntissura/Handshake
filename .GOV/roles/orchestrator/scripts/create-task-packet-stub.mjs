...
content = fill(content, "{{SESSION_CONTROL_REQUESTS_FILE}}", SESSION_CONTROL_REQUESTS_FILE);
content = fill(content, "{{SESSION_CONTROL_RESULTS_FILE}}", SESSION_CONTROL_RESULTS_FILE);
content = fill(content, "{{SESSION_COMPATIBILITY_SURFACE}}", SESSION_COMPATIBILITY_SURFACE);
content = fill(content, "{{SESSION_COMPATIBILITY_QUEUE_FILE}}", SESSION_COMPATIBILITY_QUEUE_FILE);
