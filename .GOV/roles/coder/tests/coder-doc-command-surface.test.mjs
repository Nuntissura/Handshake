...
const DOC_PATHS = [
  path.resolve(".GOV", "roles", "coder", "CODER_PROTOCOL.md"),
  path.resolve(".GOV", "roles", "coder", "README.md"),
];
...
test("coder docs only reference just commands that exist in the live justfile", () => {
