...
- PROOF RUNS NEEDING A DATABASE MUST USE A WP-SCOPED DATABASE. Divergent migration sets across worktrees make a shared database fail sqlx checksum validation (`migration N was previously applied but has been modified`).
