...
const DOC_PATHS = [
  path.resolve(".GOV", "roles", "validator", "VALIDATOR_PROTOCOL.md"),
  path.resolve(".GOV", "roles", "validator", "README.md"),
];
...
test("validator docs only reference just commands that exist in the live justfile", () => {
