...
export const TOPOLOGY_REGISTRY_JSON_PATH = ".GOV/roles_shared/GIT_TOPOLOGY_REGISTRY.json";
export const TOPOLOGY_REGISTRY_MD_PATH = ".GOV/roles_shared/GIT_TOPOLOGY_REGISTRY.md";
