...
if (!wpId) {
  console.error('Usage: node .GOV/scripts/validation/post-work.mjs WP-{ID} [options]');
  process.exit(1);
}
...
const postWorkCheckPath = path.join('.GOV', 'scripts', 'validation', 'post-work-check.mjs');
const roleMailboxPath = path.join('.GOV', 'scripts', 'validation', 'role_mailbox_export_check.mjs');
