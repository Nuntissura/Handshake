...
export const WORKFLOW_LANE_VALUES = ["MANUAL_RELAY", "ORCHESTRATOR_MANAGED", "UNSPECIFIED"];
export const EXECUTION_OWNER_VALUES = ["ORCHESTRATOR", "CODER_A", "CODER_B", "UNASSIGNED"];
