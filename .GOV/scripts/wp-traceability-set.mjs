...
function main() {
  ...
  if (!baseWpId || !baseWpId.startsWith("WP-")) {
    fail("Usage: node .GOV/scripts/wp-traceability-set.mjs <BASE_WP_ID> <ACTIVE_PACKET_WP_ID>", [
      "Example: node .GOV/scripts/wp-traceability-set.mjs WP-1-Workflow-Engine WP-1-Workflow-Engine-v4",
    ]);
  }
