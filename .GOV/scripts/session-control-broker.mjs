...
import { inspectHandshakeAcpBroker, shutdownHandshakeAcpBroker } from "./handshake-acp-client.mjs";
import { assertOrchestratorLaunchAuthority } from "./session-registry-lib.mjs";
...
if (!["status", "stop"].includes(action)) {
  fail("Usage: node .GOV/scripts/session-control-broker.mjs <status|stop>");
}
