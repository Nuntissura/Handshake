...
export const SESSION_CONTROL_BROKER_BUILD_ID = "2026-03-13.4";
...
export const SESSION_CONTROL_RUN_TIMEOUT_SECONDS = 900;
...
export function normalizeActiveHostValue(value) {
  ...
  if (token === CLI_ESCALATION_HOST_DEFAULT || token === "CURRENT" || token === "PRINT") {
