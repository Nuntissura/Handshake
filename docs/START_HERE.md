...
Authority: Master Spec (see `docs/SPEC_CURRENT.md`, currently v02.110)
---
## Canonical sources
- **Spec:** `docs/SPEC_CURRENT.md` (points to the current Handshake master spec, currently v02.110).
