...
- [Handshake_Export_Bundles_Insert_Plan_v0.1.md](../Handshake_Export_Bundles_Insert_Plan_v0.1.md) - export plan.
- [Handshake_Phase_0_5_Closure_v0.1.md](../Handshake_Phase_0_5_Closure_v0.1.md) - phase closure notes.
- [extraction and digital production team.md](../extraction%20and%20digital%20production%20team.md) - team/scoping notes.
- [primitives_catalogue.md](../primitives_catalogue.md) - primitives reference.

## docs_local/ (staging, non-canonical)
- [DOC_INDEX.txt](../docs_local/DOC_INDEX.txt) - quick pointer to local docs.
- [The_Prompt_Diaries_v03.056.000_2025-11-28_01-42_CET.txt](../docs_local/legacy/The_Prompt_Diaries_v03.056.000_2025-11-28_01-42_CET.txt) - legacy prompt diary/history (non-binding).
- [Diary RID extraction.txt](../docs_local/Diary%20RID%20extraction.txt) - extraction work log.
