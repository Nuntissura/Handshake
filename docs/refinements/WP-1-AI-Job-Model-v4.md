...
- GAP-4 (Stub spec drift): `docs/task_packets/stubs/WP-1-AI-Job-Model-v4.md` references v02.105, but `docs/SPEC_CURRENT.md` resolves to v02.113. v4 refinement + packet must anchor to v02.113.
