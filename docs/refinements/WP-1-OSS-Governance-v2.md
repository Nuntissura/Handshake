...
### GAPS_IDENTIFIED
- Spec drift gap: `docs/OSS_REGISTER.md` and `src/backend/handshake_core/tests/oss_register_enforcement_tests.rs` are implemented against the older OSS Register schema (5-column table: Component/License/IntegrationMode/Scope/Purpose) and older spec references.
...
- OSS Register schema and parser contract for `docs/OSS_REGISTER.md` aligned to the Master Spec required columns.
