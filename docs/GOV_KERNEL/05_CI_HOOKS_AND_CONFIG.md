...
- Spec pointer correctness (`docs/SPEC_CURRENT.md` resolves).
...
- Prefer pointers (`docs/SPEC_CURRENT.md`) over hardcoding version strings in many places.
...
Mitigation:
- Keep canonical templates under `docs/templates/`.
