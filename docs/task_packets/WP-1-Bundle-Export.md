...
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (§7.6.3.15 / §11.5).
...
- **SPEC_ANCHOR**: §7.6.3.15, §7.6.3.Acceptance
