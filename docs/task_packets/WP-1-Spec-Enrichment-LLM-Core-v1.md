...
- REFINEMENT_FILE: docs/refinements/WP-1-Spec-Enrichment-LLM-Core-v1.md
- Rule: Task packet creation is blocked until refinement is complete and signed.

## SCOPE
- What: Apply the approved spec enrichment for LLM core trace_id transport and llm_inference event shape, then bump the Master Spec version and update docs/SPEC_CURRENT.md.
...
- SPEC_CURRENT updated: docs/SPEC_CURRENT.md points to Handshake_Master_Spec_v02.101.md.
- Audit trail: USER_SIGNATURE is present in docs/SIGNATURE_AUDIT.md and gate logs (docs/ORCHESTRATOR_GATES.json) for this WP.
