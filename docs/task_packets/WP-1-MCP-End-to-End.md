...
2. Verify implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (§11.3 MCP Gate).
...
Scope Inputs:
- Task Packet: docs/task_packets/WP-1-MCP-End-to-End.md (status: Ready for Dev; signature `<pending>`)
