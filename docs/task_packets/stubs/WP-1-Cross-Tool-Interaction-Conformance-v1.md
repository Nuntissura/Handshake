...
2. USER_SIGNATURE.
3. Create `docs/refinements/WP-1-Cross-Tool-Interaction-Conformance-v1.md`.
4. Create official task packet via `just create-task-packet WP-1-Cross-Tool-Interaction-Conformance-v1`.
5. Update `docs/TASK_BOARD.md` to move `WP-1-Cross-Tool-Interaction-Conformance-v1` out of STUB when activated.
