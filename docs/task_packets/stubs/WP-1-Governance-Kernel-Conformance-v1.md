...
- Created: 2026-01-12
- SPEC_TARGET: docs/SPEC_CURRENT.md (currently Handshake_Master_Spec_v02.107.md)
...
This stub tracks the work required to bring repo tooling and governance surfaces into explicit conformance with the Governance Kernel introduced in Handshake_Master_Spec_v02.107.md 7.5.4 and documented in `docs/GOV_KERNEL/*`.
...
- Governance drift hazards are summarized in `docs/GOV_KERNEL/90_REFERENCE_IMPLEMENTATION_HANDSHAKE.md`.
...
2. USER_SIGNATURE.
3. Create `docs/refinements/WP-1-Governance-Kernel-Conformance-v1.md`.
4. Create official task packet via `just create-task-packet WP-1-Governance-Kernel-Conformance-v1`.
5. Update `docs/TASK_BOARD.md` to move `WP-1-Governance-Kernel-Conformance-v1` out of STUB when activated.
