...
- Prior packet: `docs/task_packets/WP-1-Flight-Recorder-UI-v2.md`
...
2. USER_SIGNATURE.
3. Create `docs/refinements/WP-1-Flight-Recorder-UI-v3.md`.
4. Create official task packet via `just create-task-packet WP-1-Flight-Recorder-UI-v3`.
5. Update `docs/WP_TRACEABILITY_REGISTRY.md` to point `WP-1-Flight-Recorder-UI` -> `WP-1-Flight-Recorder-UI-v3`.
6. Update `docs/TASK_BOARD.md` to move `WP-1-Flight-Recorder-UI-v3` out of STUB when activated.
