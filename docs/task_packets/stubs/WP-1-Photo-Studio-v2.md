...
- Prior packet: `docs/task_packets/WP-1-Photo-Studio.md`
...
2. USER_SIGNATURE.
3. Create `docs/refinements/WP-1-Photo-Studio-v2.md`.
4. Create official task packet via `just create-task-packet WP-1-Photo-Studio-v2`.
5. Update `docs/WP_TRACEABILITY_REGISTRY.md` to point `WP-1-Photo-Studio` -> `WP-1-Photo-Studio-v2`.
6. Update `docs/TASK_BOARD.md` to move `WP-1-Photo-Studio-v2` out of STUB when activated.
