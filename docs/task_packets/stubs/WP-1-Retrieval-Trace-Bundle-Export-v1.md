...
- [ ] Create `docs/refinements/WP-1-Retrieval-Trace-Bundle-Export-v1.md` (approved/signed).
- [ ] Create the official task packet via `just create-task-packet WP-1-Retrieval-Trace-Bundle-Export-v1` (in `docs/task_packets/`).
