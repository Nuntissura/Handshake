...
2. Verify implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (§2.6 Workflow & Automation Engine).
3. Surface-level compliance with roadmap bullets (§7.6.3.3) is insufficient. Every line of text in the Main Body section must be implemented.
...
Scope Inputs:
- Task Packet: docs/task_packets/WP-1-Workflow-Engine.md (status: Ready for Dev)
- Spec: - **SPEC_ANCHOR**: §7.6.3.3, §2.6
