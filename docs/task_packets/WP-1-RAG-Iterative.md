...
2. Verify if implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (§2.6.6.7.5.2 Iterative Deepening).
3. Surface-level compliance with roadmap bullets (§7.6.3.17) is insufficient. Every line of text in the Main Body section must be implemented.
...
- **SPEC_ANCHOR**: §7.6.3.17, §2.6.6.7.5.2
...
Scope Inputs:
- Task Packet: docs/task_packets/WP-1-RAG-Iterative.md (status: Ready for Dev)
- Spec: - **SPEC_ANCHOR**: §7.6.3.17, §2.6.6.7.5.2
