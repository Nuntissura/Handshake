...
2. Verify implementation matches **100% of the technical rules, schemas, and invariants** found in the Main Body (§11.7.5 / §7.6.3.10).
...
Scope Inputs:
- Task Packet: docs/task_packets/WP-1-Security-Gates.md (status: Ready for Dev; signature `<pending>`)
